...
enum opt_code
{
  ...
  OPT__param_uninit_max_chain_len_ = 333,    /* --param=uninit-max-chain-len= */
  OPT__param_uninit_max_num_chains_ = 334,   /* --param=uninit-max-num-chains= */
  OPT__param_uninlined_function_insns_ = 335,/* --param=uninlined-function-insns= */
  OPT__param_uninlined_function_time_ = 336, /* --param=uninlined-function-time= */
  OPT__param_uninlined_thunk_insns_ = 337,   /* --param=uninlined-thunk-insns= */
  OPT__param_uninlined_thunk_time_ = 338,    /* --param=uninlined-thunk-time= */
  OPT__param_unlikely_bb_count_fraction_ = 339,/* --param=unlikely-bb-count-fraction= */
  OPT__param_unroll_jam_max_unroll_ = 340,   /* --param=unroll-jam-max-unroll= */
  OPT__param_unroll_jam_min_percent_ = 341,  /* --param=unroll-jam-min-percent= */
  OPT__param_use_after_scope_direct_emission_threshold_ = 342,/* --param=use-after-scope-direct-emission-threshold= */
  OPT__param_use_canonical_types_ = 343,     /* --param=use-canonical-types= */
  OPT__param_vect_epilogues_nomask_ = 344,   /* --param=vect-epilogues-nomask= */
  OPT__param_vect_force_slp_ = 345,          /* --param=vect-force-slp= */
  ...
  OPT__param_vrp_block_limit_ = 353,         /* --param=vrp-block-limit= */
  OPT__param_vrp_sparse_threshold_ = 354,    /* --param=vrp-sparse-threshold= */
  OPT__param_vrp_switch_limit_ = 355,        /* --param=vrp-switch-limit= */
  OPT__param_vrp_vector_threshold_ = 356,    /* --param=vrp-vector-threshold= */
  /* OPT__pass_exit_codes = 357, */          /* --pass-exit-codes */
  /* OPT__pedantic = 358, */                 /* --pedantic */
  /* OPT__pedantic_errors = 359, */          /* --pedantic-errors */
  /* OPT__pie = 360, */                      /* --pie */
  /* OPT__pipe = 361, */                     /* --pipe */
  /* OPT__prefix = 362, */                   /* --prefix */
  /* OPT__prefix_ = 363, */                  /* --prefix= */
  /* OPT__preprocess = 364, */               /* --preprocess */
  /* OPT__print_file_name = 365, */          /* --print-file-name */
  /* OPT__print_file_name_ = 366, */         /* --print-file-name= */
  /* OPT__print_libgcc_file_name = 367, */   /* --print-libgcc-file-name */
  /* OPT__print_missing_file_dependencies = 368, *//* --print-missing-file-dependencies */
  /* OPT__print_multi_directory = 369, */    /* --print-multi-directory */
  /* OPT__print_multi_lib = 370, */          /* --print-multi-lib */
  /* OPT__print_multi_os_directory = 371, */ /* --print-multi-os-directory */
  /* OPT__print_multiarch = 372, */          /* --print-multiarch */
  /* OPT__print_prog_name = 373, */          /* --print-prog-name */
  /* OPT__print_prog_name_ = 374, */         /* --print-prog-name= */
  /* OPT__print_search_dirs = 375, */        /* --print-search-dirs */
  /* OPT__print_sysroot = 376, */            /* --print-sysroot */
  /* OPT__print_sysroot_headers_suffix = 377, *//* --print-sysroot-headers-suffix */
  /* OPT__profile = 378, */                  /* --profile */
  /* OPT__save_temps = 379, */               /* --save-temps */
  /* OPT__shared = 380, */                   /* --shared */
  /* OPT__specs = 381, */                    /* --specs */
  /* OPT__specs_ = 382, */                   /* --specs= */
  /* OPT__static = 383, */                   /* --static */
  /* OPT__static_pie = 384, */               /* --static-pie */
  /* OPT__symbolic = 385, */                 /* --symbolic */
  /* OPT__sysroot = 386, */                  /* --sysroot */
  OPT__sysroot_ = 387,                       /* --sysroot= */
  OPT__target_help = 388,                    /* --target-help */
  /* OPT__time = 389, */                     /* --time */
  /* OPT__trace_includes = 390, */           /* --trace-includes */
  /* OPT__traditional = 391, */              /* --traditional */
  /* OPT__traditional_cpp = 392, */          /* --traditional-cpp */
  /* OPT__trigraphs = 393, */                /* --trigraphs */
  /* OPT__undefine_macro = 394, */           /* --undefine-macro */
  /* OPT__undefine_macro_ = 395, */          /* --undefine-macro= */
  /* OPT__user_dependencies = 396, */        /* --user-dependencies */
  /* OPT__verbose = 397, */                  /* --verbose */
  OPT__version = 398,                        /* --version */
  /* OPT__write_dependencies = 399, */       /* --write-dependencies */
  /* OPT__write_user_dependencies = 400, */  /* --write-user-dependencies */
  OPT_A = 401,                               /* -A */
  OPT_B = 402,                               /* -B */
  OPT_C = 403,                               /* -C */
  OPT_CC = 404,                              /* -CC */
  ...
  OPT_MQ = 421,                              /* -MQ */
  OPT_MT = 422,                              /* -MT */
  OPT_Mmodules = 423,                        /* -Mmodules */
  OPT_Mno_modules = 424,                     /* -Mno-modules */
  OPT_N = 425,                               /* -N */
  OPT_O = 426,                               /* -O */
  OPT_Ofast = 427,                           /* -Ofast */
  OPT_Og = 428,                              /* -Og */
  ...
  OPT_Tbss_ = 439,                           /* -Tbss= */
  OPT_Tdata = 440,                           /* -Tdata */
  OPT_Tdata_ = 441,                          /* -Tdata= */
  OPT_Ttext = 442,                           /* -Ttext */
  OPT_Ttext_ = 443,                          /* -Ttext= */
  OPT_U = 444,                               /* -U */
  /* OPT_W = 445, */                         /* -W */
  OPT_WNSObject_attribute = 446,             /* -WNSObject-attribute */
  OPT_Wa_ = 447,                             /* -Wa, */
  OPT_Wabi = 448,                            /* -Wabi */
  OPT_Wabi_tag = 449,                        /* -Wabi-tag */
  OPT_Wabi_ = 450,                           /* -Wabi= */
  OPT_Wabsolute_value = 451,                 /* -Wabsolute-value */
  OPT_Waddress = 452,                        /* -Waddress */
  OPT_Waddress_of_packed_member = 453,       /* -Waddress-of-packed-member */
  OPT_Waggregate_return = 454,               /* -Waggregate-return */
  OPT_Waggressive_loop_optimizations = 455,  /* -Waggressive-loop-optimizations */
  OPT_Waliasing = 456,                       /* -Waliasing */
  OPT_Walign_commons = 457,                  /* -Walign-commons */
  /* OPT_Waligned_new = 458, */              /* -Waligned-new */
  OPT_Waligned_new_ = 459,                   /* -Waligned-new= */
  OPT_Wall = 460,                            /* -Wall */
  OPT_Walloc_size = 461,                     /* -Walloc-size */
  ...
  OPT_Wanalyzer_infinite_loop = 483,         /* -Wanalyzer-infinite-loop */
  OPT_Wanalyzer_infinite_recursion = 484,    /* -Wanalyzer-infinite-recursion */
  OPT_Wanalyzer_jump_through_null = 485,     /* -Wanalyzer-jump-through-null */
  OPT_Wanalyzer_malloc_leak = 486,           /* -Wanalyzer-malloc-leak */
  OPT_Wanalyzer_mismatching_deallocation = 487,/* -Wanalyzer-mismatching-deallocation */
  OPT_Wanalyzer_null_argument = 488,         /* -Wanalyzer-null-argument */
  OPT_Wanalyzer_null_dereference = 489,      /* -Wanalyzer-null-dereference */
  OPT_Wanalyzer_out_of_bounds = 490,         /* -Wanalyzer-out-of-bounds */
  OPT_Wanalyzer_overlapping_buffers = 491,   /* -Wanalyzer-overlapping-buffers */
  OPT_Wanalyzer_possible_null_argument = 492,/* -Wanalyzer-possible-null-argument */
  OPT_Wanalyzer_possible_null_dereference = 493,/* -Wanalyzer-possible-null-dereference */
  OPT_Wanalyzer_putenv_of_auto_var = 494,    /* -Wanalyzer-putenv-of-auto-var */
  OPT_Wanalyzer_shift_count_negative = 495,  /* -Wanalyzer-shift-count-negative */
  OPT_Wanalyzer_shift_count_overflow = 496,  /* -Wanalyzer-shift-count-overflow */
  OPT_Wanalyzer_stale_setjmp_buffer = 497,   /* -Wanalyzer-stale-setjmp-buffer */
  OPT_Wanalyzer_symbol_too_complex = 498,    /* -Wanalyzer-symbol-too-complex */
  ...
  OPT_Wanalyzer_undefined_behavior_ptrdiff = 506,/* -Wanalyzer-undefined-behavior-ptrdiff */
  OPT_Wanalyzer_undefined_behavior_strtok = 507,/* -Wanalyzer-undefined-behavior-strtok */
  OPT_Wanalyzer_unsafe_call_within_signal_handler = 508,/* -Wanalyzer-unsafe-call-within-signal-handler */
  OPT_Wanalyzer_use_after_free = 509,        /* -Wanalyzer-use-after-free */
  OPT_Wanalyzer_use_of_pointer_in_stale_stack_frame = 510,/* -Wanalyzer-use-of-pointer-in-stale-stack-frame */
  OPT_Wanalyzer_use_of_uninitialized_value = 511,/* -Wanalyzer-use-of-uninitialized-value */
  OPT_Wanalyzer_va_arg_type_mismatch = 512,  /* -Wanalyzer-va-arg-type-mismatch */
  OPT_Wanalyzer_va_list_exhausted = 513,     /* -Wanalyzer-va-list-exhausted */
  OPT_Wanalyzer_va_list_leak = 514,          /* -Wanalyzer-va-list-leak */
  OPT_Wanalyzer_va_list_use_after_va_end = 515,/* -Wanalyzer-va-list-use-after-va-end */
  OPT_Wanalyzer_write_to_const = 516,        /* -Wanalyzer-write-to-const */
  OPT_Wanalyzer_write_to_string_literal = 517,/* -Wanalyzer-write-to-string-literal */
  OPT_Wargument_mismatch = 518,              /* -Wargument-mismatch */
  OPT_Warith_conversion = 519,               /* -Warith-conversion */
  /* OPT_Warray_bounds = 520, */             /* -Warray-bounds */
  OPT_Warray_bounds_ = 521,                  /* -Warray-bounds= */
  OPT_Warray_compare = 522,                  /* -Warray-compare */
  /* OPT_Warray_parameter = 523, */          /* -Warray-parameter */
  OPT_Warray_parameter_ = 524,               /* -Warray-parameter= */
  OPT_Warray_temporaries = 525,              /* -Warray-temporaries */
  OPT_Wassign_intercept = 526,               /* -Wassign-intercept */
  /* OPT_Wattribute_alias = 527, */          /* -Wattribute-alias */
  OPT_Wattribute_alias_ = 528,               /* -Wattribute-alias= */
  OPT_Wattribute_warning = 529,              /* -Wattribute-warning */
  OPT_Wattributes = 530,                     /* -Wattributes */
  OPT_Wattributes_ = 531,                    /* -Wattributes= */
  OPT_Wbad_function_cast = 532,              /* -Wbad-function-cast */
  /* OPT_Wbidi_chars = 533, */               /* -Wbidi-chars */
  OPT_Wbidi_chars_ = 534,                    /* -Wbidi-chars= */
  OPT_Wbool_compare = 535,                   /* -Wbool-compare */
  OPT_Wbool_operation = 536,                 /* -Wbool-operation */
  OPT_Wbuiltin_declaration_mismatch = 537,   /* -Wbuiltin-declaration-mismatch */
  OPT_Wbuiltin_macro_redefined = 538,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 539,                     /* -Wc++-compat */
  /* OPT_Wc__0x_compat = 540, */             /* -Wc++0x-compat */
  OPT_Wc__11_compat = 541,                   /* -Wc++11-compat */
  OPT_Wc__11_extensions = 542,               /* -Wc++11-extensions */
  OPT_Wc__14_compat = 543,                   /* -Wc++14-compat */
  OPT_Wc__14_extensions = 544,               /* -Wc++14-extensions */
  OPT_Wc__17_compat = 545,                   /* -Wc++17-compat */
  OPT_Wc__17_extensions = 546,               /* -Wc++17-extensions */
  /* OPT_Wc__1z_compat = 547, */             /* -Wc++1z-compat */
  OPT_Wc__20_compat = 548,                   /* -Wc++20-compat */
  OPT_Wc__20_extensions = 549,               /* -Wc++20-extensions */
  OPT_Wc__23_extensions = 550,               /* -Wc++23-extensions */
  OPT_Wc__26_extensions = 551,               /* -Wc++26-extensions */
  ...
  OPT_Wc23_c2y_compat = 556,                 /* -Wc23-c2y-compat */
  OPT_Wc90_c99_compat = 557,                 /* -Wc90-c99-compat */
  OPT_Wc99_c11_compat = 558,                 /* -Wc99-c11-compat */
  OPT_Wcalloc_transposed_args = 559,         /* -Wcalloc-transposed-args */
  ...
  OPT_Wcast_user_defined = 567,              /* -Wcast-user-defined */
  ...
  OPT_Wcoverage_too_many_conditions = 589,   /* -Wcoverage-too-many-conditions */
  OPT_Wcpp = 590,                            /* -Wcpp */
  ...
  OPT_Wdefaulted_function_deleted = 600,     /* -Wdefaulted-function-deleted */
  OPT_Wdelete_incomplete = 601,              /* -Wdelete-incomplete */
  OPT_Wdelete_non_virtual_dtor = 602,        /* -Wdelete-non-virtual-dtor */
  OPT_Wdeprecated = 603,                     /* -Wdeprecated */
  OPT_Wdeprecated_copy = 604,                /* -Wdeprecated-copy */
  OPT_Wdeprecated_copy_dtor = 605,           /* -Wdeprecated-copy-dtor */
  OPT_Wdeprecated_declarations = 606,        /* -Wdeprecated-declarations */
  OPT_Wdeprecated_enum_enum_conversion = 607,/* -Wdeprecated-enum-enum-conversion */
  OPT_Wdeprecated_enum_float_conversion = 608,/* -Wdeprecated-enum-float-conversion */
  OPT_Wdesignated_init = 609,                /* -Wdesignated-init */
  OPT_Wdisabled_optimization = 610,          /* -Wdisabled-optimization */
  OPT_Wdiscarded_array_qualifiers = 611,     /* -Wdiscarded-array-qualifiers */
  OPT_Wdiscarded_qualifiers = 612,           /* -Wdiscarded-qualifiers */
  OPT_Wdiv_by_zero = 613,                    /* -Wdiv-by-zero */
  OPT_Wdo_subscript = 614,                   /* -Wdo-subscript */
  OPT_Wdouble_promotion = 615,               /* -Wdouble-promotion */
  OPT_Wduplicate_decl_specifier = 616,       /* -Wduplicate-decl-specifier */
  OPT_Wduplicated_branches = 617,            /* -Wduplicated-branches */
  OPT_Wduplicated_cond = 618,                /* -Wduplicated-cond */
  OPT_Weffc__ = 619,                         /* -Weffc++ */
  OPT_Welaborated_enum_base = 620,           /* -Welaborated-enum-base */
  OPT_Wempty_body = 621,                     /* -Wempty-body */
  OPT_Wendif_labels = 622,                   /* -Wendif-labels */
  OPT_Wenum_compare = 623,                   /* -Wenum-compare */
  OPT_Wenum_conversion = 624,                /* -Wenum-conversion */
  OPT_Wenum_int_mismatch = 625,              /* -Wenum-int-mismatch */
  OPT_Werror = 626,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 627, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 628,                         /* -Werror= */
  OPT_Wexceptions = 629,                     /* -Wexceptions */
  OPT_Wexpansion_to_defined = 630,           /* -Wexpansion-to-defined */
  OPT_Wextra = 631,                          /* -Wextra */
  OPT_Wextra_semi = 632,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 633,                   /* -Wfatal-errors */
  OPT_Wflex_array_member_not_at_end = 634,   /* -Wflex-array-member-not-at-end */
  OPT_Wfloat_conversion = 635,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 636,                    /* -Wfloat-equal */
  /* OPT_Wformat = 637, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 638,            /* -Wformat-contains-nul */
  OPT_Wformat_diag = 639,                    /* -Wformat-diag */
  OPT_Wformat_extra_args = 640,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 641,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 642, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 643,               /* -Wformat-overflow= */
  OPT_Wformat_security = 644,                /* -Wformat-security */
  OPT_Wformat_signedness = 645,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 646, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 647,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 648,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 649,             /* -Wformat-zero-length */
  OPT_Wformat_ = 650,                        /* -Wformat= */
  OPT_Wframe_address = 651,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 652,             /* -Wframe-larger-than= */
  OPT_Wfree_nonheap_object = 653,            /* -Wfree-nonheap-object */
  OPT_Wfrontend_loop_interchange = 654,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 655,           /* -Wfunction-elimination */
  OPT_Wglobal_module = 656,                  /* -Wglobal-module */
  OPT_Whardened = 657,                       /* -Whardened */
  /* OPT_Whsa = 658, */                      /* -Whsa */
  OPT_Wif_not_aligned = 659,                 /* -Wif-not-aligned */
  OPT_Wignored_attributes = 660,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 661,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 662,                       /* -Wimplicit */
  /* OPT_Wimplicit_fallthrough = 663, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 664,          /* -Wimplicit-fallthrough= */
  OPT_Wimplicit_function_declaration = 665,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 666,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 667,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 668,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 669, */                   /* -Wimport */
  OPT_Winaccessible_base = 670,              /* -Winaccessible-base */
  OPT_Wincompatible_pointer_types = 671,     /* -Wincompatible-pointer-types */
  OPT_Winfinite_recursion = 672,             /* -Winfinite-recursion */
  OPT_Winherited_variadic_ctor = 673,        /* -Winherited-variadic-ctor */
  OPT_Winit_list_lifetime = 674,             /* -Winit-list-lifetime */
  OPT_Winit_self = 675,                      /* -Winit-self */
  OPT_Winline = 676,                         /* -Winline */
  OPT_Wint_conversion = 677,                 /* -Wint-conversion */
  OPT_Wint_in_bool_context = 678,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 679,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 680,               /* -Winteger-division */
  OPT_Winterference_size = 681,              /* -Winterference-size */
  OPT_Wintrinsic_shadow = 682,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 683,                 /* -Wintrinsics-std */
  OPT_Winvalid_constexpr = 684,              /* -Winvalid-constexpr */
  OPT_Winvalid_imported_macros = 685,        /* -Winvalid-imported-macros */
  OPT_Winvalid_memory_model = 686,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 687,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 688,                    /* -Winvalid-pch */
  OPT_Winvalid_utf8 = 689,                   /* -Winvalid-utf8 */
  OPT_Wjump_misses_init = 690,               /* -Wjump-misses-init */
  OPT_Wl_ = 691,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 692, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 693,                   /* -Wlarger-than= */
  OPT_Wline_truncation = 694,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 695,                 /* -Wliteral-suffix */
  OPT_Wlogical_not_parentheses = 696,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 697,                     /* -Wlogical-op */
  OPT_Wlong_long = 698,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 699,              /* -Wlto-type-mismatch */
  OPT_Wmain = 700,                           /* -Wmain */
  OPT_Wmaybe_uninitialized = 701,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 702,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 703,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 704,         /* -Wmisleading-indentation */
  OPT_Wmismatched_dealloc = 705,             /* -Wmismatched-dealloc */
  OPT_Wmismatched_new_delete = 706,          /* -Wmismatched-new-delete */
  OPT_Wmismatched_special_enum = 707,        /* -Wmismatched-special-enum */
  OPT_Wmismatched_tags = 708,                /* -Wmismatched-tags */
  OPT_Wmissing_attributes = 709,             /* -Wmissing-attributes */
  OPT_Wmissing_braces = 710,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 711,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 712,     /* -Wmissing-field-initializers */
  /* OPT_Wmissing_format_attribute = 713, */ /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 714,           /* -Wmissing-include-dirs */
  /* OPT_Wmissing_noreturn = 715, */         /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_type = 716,         /* -Wmissing-parameter-type */
  OPT_Wmissing_profile = 717,                /* -Wmissing-profile */
  OPT_Wmissing_prototypes = 718,             /* -Wmissing-prototypes */
  OPT_Wmissing_requires = 719,               /* -Wmissing-requires */
  OPT_Wmissing_template_keyword = 720,       /* -Wmissing-template-keyword */
  OPT_Wmissing_variable_declarations = 721,  /* -Wmissing-variable-declarations */
  OPT_Wmudflap = 722,                        /* -Wmudflap */
  OPT_Wmultichar = 723,                      /* -Wmultichar */
  OPT_Wmultiple_inheritance = 724,           /* -Wmultiple-inheritance */
  OPT_Wmultistatement_macros = 725,          /* -Wmultistatement-macros */
  OPT_Wnamespaces = 726,                     /* -Wnamespaces */
  OPT_Wnarrowing = 727,                      /* -Wnarrowing */
  OPT_Wnested_externs = 728,                 /* -Wnested-externs */
  /* OPT_Wno_alloc_size_larger_than = 729, *//* -Wno-alloc-size-larger-than */
  /* OPT_Wno_alloca_larger_than = 730, */    /* -Wno-alloca-larger-than */
  /* OPT_Wno_frame_larger_than = 731, */     /* -Wno-frame-larger-than */
  /* OPT_Wno_larger_than = 732, */           /* -Wno-larger-than */
  /* OPT_Wno_stack_usage = 733, */           /* -Wno-stack-usage */
  /* OPT_Wno_vla_larger_than = 734, */       /* -Wno-vla-larger-than */
  OPT_Wnoexcept = 735,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 736,                  /* -Wnoexcept-type */
  OPT_Wnon_template_friend = 737,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 738,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 739,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 740,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 741, */               /* -Wnormalized */
  OPT_Wnormalized_ = 742,                    /* -Wnormalized= */
  OPT_Wnrvo = 743,                           /* -Wnrvo */
  OPT_Wnull_dereference = 744,               /* -Wnull-dereference */
  OPT_Wobjc_root_class = 745,                /* -Wobjc-root-class */
  OPT_Wodr = 746,                            /* -Wodr */
  OPT_Wold_style_cast = 747,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 748,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 749,           /* -Wold-style-definition */
  OPT_Wopenacc_parallelism = 750,            /* -Wopenacc-parallelism */
  OPT_Wopenmp = 751,                         /* -Wopenmp */
  OPT_Wopenmp_simd = 752,                    /* -Wopenmp-simd */
  OPT_Woverflow = 753,                       /* -Woverflow */
  OPT_Woverlength_strings = 754,             /* -Woverlength-strings */
  /* OPT_Woverloaded_virtual = 755, */       /* -Woverloaded-virtual */
  OPT_Woverloaded_virtual_ = 756,            /* -Woverloaded-virtual= */
  OPT_Woverride_init = 757,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 758,     /* -Woverride-init-side-effects */
  OPT_Woverwrite_recursive = 759,            /* -Woverwrite-recursive */
  OPT_Wp_ = 760,                             /* -Wp, */
  OPT_Wpacked = 761,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 762,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 763,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 764,                         /* -Wpadded */
  OPT_Wparentheses = 765,                    /* -Wparentheses */
  OPT_Wpedantic = 766,                       /* -Wpedantic */
  OPT_Wpedantic_cast = 767,                  /* -Wpedantic-cast */
  OPT_Wpedantic_param_names = 768,           /* -Wpedantic-param-names */
  OPT_Wpessimizing_move = 769,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 770, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 771,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 772,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 773,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 774,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 775,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 776,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 777,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 778,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 779,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 780,                       /* -Wprotocol */
  OPT_Wpsabi = 781,                          /* -Wpsabi */
  OPT_Wrange_loop_construct = 782,           /* -Wrange-loop-construct */
  OPT_Wreal_q_constant = 783,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 784,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 785,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 786,                /* -Wredundant-decls */
  OPT_Wredundant_move = 787,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 788,                 /* -Wredundant-tags */
  OPT_Wregister = 789,                       /* -Wregister */
  OPT_Wreorder = 790,                        /* -Wreorder */
  OPT_Wrestrict = 791,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 792,              /* -Wreturn-local-addr */
  OPT_Wreturn_mismatch = 793,                /* -Wreturn-mismatch */
  OPT_Wreturn_type = 794,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 795,           /* -Wscalar-storage-order */
  OPT_Wselector = 796,                       /* -Wselector */
  OPT_Wself_move = 797,                      /* -Wself-move */
  OPT_Wsequence_point = 798,                 /* -Wsequence-point */
  OPT_Wshadow = 799,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 800, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 801,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 802, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 803,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 804, */            /* -Wshadow=global */
  OPT_Wshadow_local = 805,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 806,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 807,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 808,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 809, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 810,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 811,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 812,                /* -Wsign-conversion */
  OPT_Wsign_promo = 813,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 814,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 815,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_array_div = 816,               /* -Wsizeof-array-div */
  OPT_Wsizeof_pointer_div = 817,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 818,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 819,                    /* -Wspeculative */
  OPT_Wstack_protector = 820,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 821,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 822,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 823,               /* -Wstrict-aliasing= */
  OPT_Wstrict_flex_arrays = 824,             /* -Wstrict-flex-arrays */
  OPT_Wstrict_null_sentinel = 825,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 826,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 827,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 828,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 829,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 830,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 831, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 832,             /* -Wstringop-overflow= */
  OPT_Wstringop_overread = 833,              /* -Wstringop-overread */
  OPT_Wstringop_truncation = 834,            /* -Wstringop-truncation */
  OPT_Wstyle = 835,                          /* -Wstyle */
  OPT_Wsubobject_linkage = 836,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 837,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 838,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 839,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 840,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 841,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 842,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_attribute_returns_nonnull = 843,/* -Wsuggest-attribute=returns_nonnull */
  OPT_Wsuggest_final_methods = 844,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 845,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 846,               /* -Wsuggest-override */
  OPT_Wsurprising = 847,                     /* -Wsurprising */
  OPT_Wswitch = 848,                         /* -Wswitch */
  OPT_Wswitch_bool = 849,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 850,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 851,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 852,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 853,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 854,                      /* -Wsync-nand */
  OPT_Wsynth = 855,                          /* -Wsynth */
  OPT_Wsystem_headers = 856,                 /* -Wsystem-headers */
  OPT_Wtabs = 857,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 858,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 859,           /* -Wtautological-compare */
  OPT_Wtemplate_body = 860,                  /* -Wtemplate-body */
  OPT_Wtemplate_id_cdtor = 861,              /* -Wtemplate-id-cdtor */
  ...
  OPT_Wunterminated_string_initialization = 883,/* -Wunterminated-string-initialization */
  OPT_Wunused = 884,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 885,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 886,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 887, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 888,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 889,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 890,                /* -Wunused-function */
  OPT_Wunused_label = 891,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 892,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 893,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 894,               /* -Wunused-parameter */
  OPT_Wunused_result = 895,                  /* -Wunused-result */
  OPT_Wunused_value = 896,                   /* -Wunused-value */
  OPT_Wunused_variable = 897,                /* -Wunused-variable */
  OPT_Wuse_after_free = 898,                 /* -Wuse-after-free */
  OPT_Wuse_after_free_ = 899,                /* -Wuse-after-free= */
  OPT_Wuse_without_only = 900,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 901,                   /* -Wuseless-cast */
  OPT_Wvarargs = 902,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 903,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 904,   /* -Wvector-operation-performance */
  OPT_Wverbose_unbounded = 905,              /* -Wverbose-unbounded */
  OPT_Wvexing_parse = 906,                   /* -Wvexing-parse */
  OPT_Wvirtual_inheritance = 907,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 908,            /* -Wvirtual-move-assign */
  OPT_Wvla = 909,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 910,               /* -Wvla-larger-than= */
  OPT_Wvla_parameter = 911,                  /* -Wvla-parameter */
  OPT_Wvolatile = 912,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 913,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 914,                  /* -Wwrite-strings */
  OPT_Wxor_used_as_pow = 915,                /* -Wxor-used-as-pow */
  OPT_Wzero_as_null_pointer_constant = 916,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 917,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 918,                       /* -Wzerotrip */
  OPT_X = 919,                               /* -X */
  OPT_Xassembler = 920,                      /* -Xassembler */
  OPT_Xf = 921,                              /* -Xf */
  OPT_Xlinker = 922,                         /* -Xlinker */
  OPT_Xpreprocessor = 923,                   /* -Xpreprocessor */
  OPT_Z = 924,                               /* -Z */
  OPT_ansi = 925,                            /* -ansi */
  OPT_aux_info = 926,                        /* -aux-info */
  /* OPT_aux_info_ = 927, */                 /* -aux-info= */
  OPT_c = 928,                               /* -c */
  OPT_callgraph = 929,                       /* -callgraph */
  OPT_coverage = 930,                        /* -coverage */
  OPT_cpp = 931,                             /* -cpp */
  OPT_cpp_ = 932,                            /* -cpp= */
  OPT_d = 933,                               /* -d */
  OPT_debuglib_ = 934,                       /* -debuglib= */
  OPT_defaultlib_ = 935,                     /* -defaultlib= */
  OPT_defined_only = 936,                    /* -defined-only */
  OPT_demangle = 937,                        /* -demangle */
  OPT_dstartfiles = 938,                     /* -dstartfiles */
  OPT_dump_body_ = 939,                      /* -dump-body= */
  OPT_dump_level_ = 940,                     /* -dump-level= */
  OPT_dumpbase = 941,                        /* -dumpbase */
  OPT_dumpbase_ext = 942,                    /* -dumpbase-ext */
  OPT_dumpdir = 943,                         /* -dumpdir */
  OPT_dumpfullversion = 944,                 /* -dumpfullversion */
  OPT_dumpmachine = 945,                     /* -dumpmachine */
  OPT_dumpspecs = 946,                       /* -dumpspecs */
  OPT_dumpversion = 947,                     /* -dumpversion */
  OPT_e = 948,                               /* -e */
  OPT_export_dynamic = 949,                  /* -export-dynamic */
  OPT_fPIC = 950,                            /* -fPIC */
  OPT_fPIE = 951,                            /* -fPIE */
  OPT_fRTS_ = 952,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 953,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 954,                   /* -fabi-version= */
  OPT_faccess_control = 955,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 956,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 957,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 958,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 959,                  /* -falign-commons */
  OPT_falign_functions = 960,                /* -falign-functions */
  OPT_falign_functions_ = 961,               /* -falign-functions= */
  OPT_falign_jumps = 962,                    /* -falign-jumps */
  OPT_falign_jumps_ = 963,                   /* -falign-jumps= */
  OPT_falign_labels = 964,                   /* -falign-labels */
  OPT_falign_labels_ = 965,                  /* -falign-labels= */
  OPT_falign_loops = 966,                    /* -falign-loops */
  OPT_falign_loops_ = 967,                   /* -falign-loops= */
  /* OPT_faligned_new = 968, */              /* -faligned-new */
  OPT_faligned_new_ = 969,                   /* -faligned-new= */
  OPT_fall_instantiations = 970,             /* -fall-instantiations */
  OPT_fall_intrinsics = 971,                 /* -fall-intrinsics */
  OPT_fall_virtual = 972,                    /* -fall-virtual */
  OPT_fallocation_dce = 973,                 /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 974,        /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 975,              /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 976,       /* -fallow-leading-underscore */
  /* OPT_fallow_parameterless_variadic_functions = 977, *//* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 978,         /* -fallow-store-data-races */
  OPT_falt_external_templates = 979,         /* -falt-external-templates */
  OPT_fanalyzer = 980,                       /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 981,        /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 982,              /* -fanalyzer-checker= */
  OPT_fanalyzer_debug_text_art = 983,        /* -fanalyzer-debug-text-art */
  OPT_fanalyzer_feasibility = 984,           /* -fanalyzer-feasibility */
  OPT_fanalyzer_fine_grained = 985,          /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 986,  /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_show_events_in_system_headers = 987,/* -fanalyzer-show-events-in-system-headers */
  OPT_fanalyzer_state_merge = 988,           /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 989,           /* -fanalyzer-state-purge */
  OPT_fanalyzer_suppress_followups = 990,    /* -fanalyzer-suppress-followups */
  OPT_fanalyzer_transitivity = 991,          /* -fanalyzer-transitivity */
  OPT_fanalyzer_undo_inlining = 992,         /* -fanalyzer-undo-inlining */
  OPT_fanalyzer_verbose_edges = 993,         /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 994, /* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 995,            /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 996, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 997, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 998, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 999, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 1000,           /* -fasan-shadow-offset= */
  OPT_fasm = 1001,                           /* -fasm */
  OPT_fassert = 1002,                        /* -fassert */
  OPT_fassociative_math = 1003,              /* -fassociative-math */
  OPT_fasynchronous_unwind_tables = 1004,    /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 1005,                  /* -fauto-inc-dec */
  OPT_fauto_init = 1006,                     /* -fauto-init */
  OPT_fauto_profile = 1007,                  /* -fauto-profile */
  OPT_fauto_profile_ = 1008,                 /* -fauto-profile= */
  OPT_fautomatic = 1009,                     /* -fautomatic */
  OPT_fbackslash = 1010,                     /* -fbackslash */
  OPT_fbacktrace = 1011,                     /* -fbacktrace */
  OPT_fbit_tests = 1012,                     /* -fbit-tests */
  OPT_fblas_matmul_limit_ = 1013,            /* -fblas-matmul-limit= */
  OPT_fbounds = 1014,                        /* -fbounds */
  OPT_fbounds_check = 1015,                  /* -fbounds-check */
  OPT_fbounds_check_ = 1016,                 /* -fbounds-check= */
  OPT_fbranch_count_reg = 1017,              /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 1018,          /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 1019, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 1020, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 1021, */        /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 1022,               /* -fbuilding-libgcc */
  OPT_fbuilding_libgfortran = 1023,          /* -fbuilding-libgfortran */
  OPT_fbuilding_libphobos_tests = 1024,      /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 1025,                       /* -fbuiltin */
  OPT_fbuiltin_ = 1026,                      /* -fbuiltin- */
  OPT_fbuiltin_printf = 1027,                /* -fbuiltin-printf */
  OPT_fc_prototypes = 1028,                  /* -fc-prototypes */
  OPT_fc_prototypes_external = 1029,         /* -fc-prototypes-external */
  OPT_fcall_saved_ = 1030,                   /* -fcall-saved- */
  OPT_fcall_used_ = 1031,                    /* -fcall-used- */
  OPT_fcaller_saves = 1032,                  /* -fcaller-saves */
  OPT_fcallgraph_info = 1033,                /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 1034,               /* -fcallgraph-info= */
  OPT_fcanon_prefix_map = 1035,              /* -fcanon-prefix-map */
  OPT_fcanonical_system_headers = 1036,      /* -fcanonical-system-headers */
  OPT_fcase = 1037,                          /* -fcase */
  /* OPT_fcf_protection = 1038, */           /* -fcf-protection */
  OPT_fcf_protection_ = 1039,                /* -fcf-protection= */
  OPT_fchar8_t = 1040,                       /* -fchar8_t */
  OPT_fcheck_array_temporaries = 1041,       /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 1042, */         /* -fcheck-data-deps */
  OPT_fcheck_new = 1043,                     /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 1044,          /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 1045,                        /* -fcheck= */
  /* OPT_fcheck_assert = 1046, */            /* -fcheck=assert */
  /* OPT_fcheck_bounds = 1047, */            /* -fcheck=bounds */
  /* OPT_fcheck_in = 1048, */                /* -fcheck=in */
  /* OPT_fcheck_invariant = 1049, */         /* -fcheck=invariant */
  /* OPT_fcheck_out = 1050, */               /* -fcheck=out */
  /* OPT_fcheck_switch = 1051, */            /* -fcheck=switch */
  OPT_fcheckaction_ = 1052,                  /* -fcheckaction= */
  OPT_fchecking = 1053,                      /* -fchecking */
  OPT_fchecking_ = 1054,                     /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 1055,    /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 1056,               /* -fchkp-check-read */
  OPT_fchkp_check_write = 1057,              /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 1058,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 1059,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 1060,         /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 1061,   /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 1062,            /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 1063,/* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 1064,                 /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 1065,             /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 1066,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 1067,/* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 1068,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 1069,        /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 1070,  /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 1071,             /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 1072,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 1073, */                /* -fcilkplus */
  OPT_fcoarray_ = 1074,                      /* -fcoarray= */
  OPT_fcode_hoisting = 1075,                 /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 1076,     /* -fcombine-stack-adjustments */
  OPT_fcommon = 1077,                        /* -fcommon */
  OPT_fcompare_debug = 1078,                 /* -fcompare-debug */
  OPT_fcompare_debug_second = 1079,          /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 1080,                /* -fcompare-debug= */
  OPT_fcompare_elim = 1081,                  /* -fcompare-elim */
  OPT_fconcepts = 1082,                      /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 1083,   /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 1084,                   /* -fconcepts-ts */
  OPT_fcond_mismatch = 1085,                 /* -fcond-mismatch */
  OPT_fcondition_coverage = 1086,            /* -fcondition-coverage */
  ...
  OPT_fdiagnostics_show_event_links = 1173,  /* -fdiagnostics-show-event-links */
  OPT_fdiagnostics_show_highlight_colors = 1174,/* -fdiagnostics-show-highlight-colors */
  ...
  OPT_fext_dce = 1247,                       /* -fext-dce */
  OPT_fext_numeric_literals = 1248,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1249,          /* -fextended-identifiers */
  OPT_fextended_opaque = 1250,               /* -fextended-opaque */
  OPT_fextern_std_ = 1251,                   /* -fextern-std= */
  OPT_fextern_tls_init = 1252,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1253,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1254,            /* -fexternal-templates */
  OPT_ff2c = 1255,                           /* -ff2c */
  OPT_ffast_math = 1256,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1257,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1258,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1259,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1260,              /* -ffinite-math-only */
  OPT_ffixed_ = 1261,                        /* -ffixed- */
  OPT_ffixed_form = 1262,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1263,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1264,        /* -ffixed-line-length-none */
  OPT_ffloat_store = 1265,                   /* -ffloat-store */
  OPT_ffloatvalue = 1266,                    /* -ffloatvalue */
  OPT_ffold_mem_offsets = 1267,              /* -ffold-mem-offsets */
  OPT_ffold_simple_inlines = 1268,           /* -ffold-simple-inlines */
  OPT_ffor_scope = 1269,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1270, */              /* -fforce-addr */
  OPT_fforward_propagate = 1271,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1272,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1273,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1274,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1275,                     /* -ffpe-trap= */
  OPT_ffree_form = 1276,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1277,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1278,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1279,                  /* -ffreestanding */
  OPT_ffriend_injection = 1280,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1281,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1282,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1283,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1284,             /* -ffunction-sections */
  OPT_fgcse = 1285,                          /* -fgcse */
  OPT_fgcse_after_reload = 1286,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1287,                      /* -fgcse-las */
  OPT_fgcse_lm = 1288,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1289,                       /* -fgcse-sm */
  OPT_fgen_module_list_ = 1290,              /* -fgen-module-list= */
  OPT_fgimple = 1291,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1292,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1293,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1294,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1295,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1296,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1297,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1298,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1299,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1300,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1301,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1302,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1303,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1304,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1305,                      /* -fgo-dump- */
  OPT_fgo_embedcfg_ = 1306,                  /* -fgo-embedcfg= */
  OPT_fgo_importcfg_ = 1307,                 /* -fgo-importcfg= */
  OPT_fgo_optimize_ = 1308,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1309,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1310,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1311,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1312,                      /* -fgraphite */
  OPT_fgraphite_identity = 1313,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1314,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1315,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1316, */       /* -fhandle-exceptions */
  OPT_fhardcfr_check_exceptions = 1317,      /* -fhardcfr-check-exceptions */
  OPT_fhardcfr_check_noreturn_calls_ = 1318, /* -fhardcfr-check-noreturn-calls= */
  OPT_fhardcfr_check_returning_calls = 1319, /* -fhardcfr-check-returning-calls */
  OPT_fhardcfr_skip_leaf = 1320,             /* -fhardcfr-skip-leaf */
  OPT_fharden_compares = 1321,               /* -fharden-compares */
  OPT_fharden_conditional_branches = 1322,   /* -fharden-conditional-branches */
  OPT_fharden_control_flow_redundancy = 1323,/* -fharden-control-flow-redundancy */
  OPT_fhardened = 1324,                      /* -fhardened */
  /* OPT_fhelp = 1325, */                    /* -fhelp */
  /* OPT_fhelp_ = 1326, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1327,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1328,                     /* -fhonor-std */
  OPT_fhosted = 1329,                        /* -fhosted */
  OPT_fhuge_objects = 1330,                  /* -fhuge-objects */
  OPT_fident = 1331,                         /* -fident */
  OPT_fif_conversion = 1332,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1333,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1334,        /* -fignore-unknown-pragmas */
  OPT_fimmediate_escalation = 1335,          /* -fimmediate-escalation */
  OPT_fimplement_inlines = 1336,             /* -fimplement-inlines */
  OPT_fimplicit_constexpr = 1337,            /* -fimplicit-constexpr */
  OPT_fimplicit_inline_templates = 1338,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1339,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1340,            /* -fimplicit-templates */
  OPT_findex = 1341,                         /* -findex */
  OPT_findirect_inlining = 1342,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1343,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1344,               /* -finit-character= */
  OPT_finit_derived = 1345,                  /* -finit-derived */
  OPT_finit_integer_ = 1346,                 /* -finit-integer= */
  OPT_finit_local_zero = 1347,               /* -finit-local-zero */
  OPT_finit_logical_ = 1348,                 /* -finit-logical= */
  OPT_finit_real_ = 1349,                    /* -finit-real= */
  OPT_finline = 1350,                        /* -finline */
  OPT_finline_arg_packing = 1351,            /* -finline-arg-packing */
  OPT_finline_atomics = 1352,                /* -finline-atomics */
  OPT_finline_functions = 1353,              /* -finline-functions */
  OPT_finline_functions_called_once = 1354,  /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 1355, */           /* -finline-limit- */
  OPT_finline_limit_ = 1356,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1357,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1358,        /* -finline-small-functions */
  OPT_finline_stringops = 1359,              /* -finline-stringops */
  OPT_finline_stringops_ = 1360,             /* -finline-stringops= */
  OPT_finput_charset_ = 1361,                /* -finput-charset= */
  OPT_finstrument_functions = 1362,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1363,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1364,/* -finstrument-functions-exclude-function-list= */
  OPT_finstrument_functions_once = 1365,     /* -finstrument-functions-once */
  OPT_finteger_4_integer_8 = 1366,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1367,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1368,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1369,                    /* -finvariants */
  OPT_fipa_bit_cp = 1370,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1371,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1372, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1373,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1374,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1375,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1376,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1377, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1378,                    /* -fipa-modref */
  OPT_fipa_profile = 1379,                   /* -fipa-profile */
  OPT_fipa_pta = 1380,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1381,                /* -fipa-pure-const */
  OPT_fipa_ra = 1382,                        /* -fipa-ra */
  OPT_fipa_reference = 1383,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1384,     /* -fipa-reference-addressable */
  OPT_fipa_sra = 1385,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1386,           /* -fipa-stack-alignment */
  OPT_fipa_strict_aliasing = 1387,           /* -fipa-strict-aliasing */
  /* OPT_fipa_struct_reorg = 1388, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1389,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1390,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1391,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1392,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1393,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1394,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1395,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1396,                  /* -fira-verbose= */
  OPT_fiso = 1397,                           /* -fiso */
  OPT_fisolate_erroneous_paths_attribute = 1398,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1399,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1400,              /* -fivar-visibility= */
  OPT_fivopts = 1401,                        /* -fivopts */
  OPT_fjump_tables = 1402,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1403,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1404,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1405,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1406,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1407,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1408,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1409,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1410,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1411,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1412,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1413,         /* -flang-info-module-cmi= */
  OPT_flarge_source_files = 1414,            /* -flarge-source-files */
  OPT_flate_combine_instructions = 1415,     /* -flate-combine-instructions */
  OPT_flax_vector_conversions = 1416,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1417,            /* -fleading-underscore */
  OPT_flibs_ = 1418,                         /* -flibs= */
  OPT_flifetime_dse = 1419,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1420,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1421,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1422,                /* -flinker-output= */
  /* OPT_flive_patching = 1423, */           /* -flive-patching */
  OPT_flive_patching_ = 1424,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1425,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1426,                   /* -flocal-ivars */
  OPT_flocation_ = 1427,                     /* -flocation= */
  /* OPT_floop_block = 1428, */              /* -floop-block */
  /* OPT_floop_flatten = 1429, */            /* -floop-flatten */
  OPT_floop_interchange = 1430,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1431,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1432, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1433,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1434, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1435,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1436,                     /* -flra-remat */
  OPT_flto = 1437,                           /* -flto */
  OPT_flto_compression_level_ = 1438,        /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 1439, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1440,                /* -flto-partition= */
  OPT_flto_report = 1441,                    /* -flto-report */
  OPT_flto_report_wpa = 1442,                /* -flto-report-wpa */
  OPT_flto_ = 1443,                          /* -flto= */
  OPT_fltrans = 1444,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1445,           /* -fltrans-output-list= */
  OPT_fm2_debug_trace_ = 1446,               /* -fm2-debug-trace= */
  OPT_fm2_dump_decl_ = 1447,                 /* -fm2-dump-decl= */
  OPT_fm2_dump_filter_ = 1448,               /* -fm2-dump-filter= */
  OPT_fm2_dump_gimple_ = 1449,               /* -fm2-dump-gimple= */
  OPT_fm2_dump_quad_ = 1450,                 /* -fm2-dump-quad= */
  OPT_fm2_dump_ = 1451,                      /* -fm2-dump= */
  OPT_fm2_g = 1452,                          /* -fm2-g */
  OPT_fm2_lower_case = 1453,                 /* -fm2-lower-case */
  OPT_fm2_pathname_ = 1454,                  /* -fm2-pathname= */
  OPT_fm2_pathnameI = 1455,                  /* -fm2-pathnameI */
  OPT_fm2_plugin = 1456,                     /* -fm2-plugin */
  OPT_fm2_prefix_ = 1457,                    /* -fm2-prefix= */
  OPT_fm2_statistics = 1458,                 /* -fm2-statistics */
  OPT_fm2_strict_type = 1459,                /* -fm2-strict-type */
  OPT_fm2_whole_program = 1460,              /* -fm2-whole-program */
  OPT_fmacro_prefix_map_ = 1461,             /* -fmacro-prefix-map= */
  OPT_fmain = 1462,                          /* -fmain */
  OPT_fmath_errno = 1463,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1464,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1465,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1466,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1467,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1468,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1469,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1470,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1471,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1472,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1473,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1474,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1475,               /* -fmessage-length= */
  OPT_fmin_function_alignment_ = 1476,       /* -fmin-function-alignment= */
  OPT_fmod_ = 1477,                          /* -fmod= */
  OPT_fmodule_file_ = 1478,                  /* -fmodule-file= */
  OPT_fmodule_header = 1479,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1480,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1481,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1482,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1483,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1484,                   /* -fmodule-only */
  OPT_fmodule_private = 1485,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1486,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1487,                    /* -fmoduleinfo */
  OPT_fmodules_ts = 1488,                    /* -fmodules-ts */
  OPT_fmodulo_sched = 1489,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1490,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1491,          /* -fmove-loop-invariants */
  OPT_fmove_loop_stores = 1492,              /* -fmove-loop-stores */
  OPT_fms_extensions = 1493,                 /* -fms-extensions */
  OPT_fmudflap = 1494,                       /* -fmudflap */
  OPT_fmudflapir = 1495,                     /* -fmudflapir */
  OPT_fmudflapth = 1496,                     /* -fmudflapth */
  OPT_fmultiflags = 1497,                    /* -fmultiflags */
  OPT_fname_mangling_version_ = 1498,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1499,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1500,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1501,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1502,                  /* -fnext-runtime */
  OPT_fnil = 1503,                           /* -fnil */
  OPT_fnil_receivers = 1504,                 /* -fnil-receivers */
  OPT_fno_inline_stringops = 1505,           /* -fno-inline-stringops */
  OPT_fno_modules = 1506,                    /* -fno-modules */
  OPT_fnon_call_exceptions = 1507,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1508,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1509,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1510,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1511,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1512,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1513,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1514,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1515,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1516,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1517,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1518,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_host_opts_ = 1519,        /* -foffload-abi-host-opts= */
  ...
  OPT_funsigned = 1865,                      /* -funsigned */
  OPT_funsigned_bitfields = 1866,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1867,                 /* -funsigned-char */
  OPT_funswitch_loops = 1868,                /* -funswitch-loops */
  OPT_funwind_tables = 1869,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1870,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1871,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1872,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1873,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1874,                    /* -fuse-ld=lld */
  OPT_fuse_ld_mold = 1875,                   /* -fuse-ld=mold */
  OPT_fuse_linker_plugin = 1876,             /* -fuse-linker-plugin */
  OPT_fuse_list_ = 1877,                     /* -fuse-list= */
  OPT_fvar_tracking = 1878,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1879,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1880,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1881,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1882,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1883, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1884,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1885,                   /* -fverbose-asm */
  /* OPT_fversion = 1886, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1887,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1888,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1889,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1890,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1891,                   /* -fvisibility= */
  OPT_fvpt = 1892,                           /* -fvpt */
  OPT_fvtable_gc = 1893,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1894,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1895,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1896,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1897,                     /* -fvtv-debug */
  OPT_fweak = 1898,                          /* -fweak */
  OPT_fweak_templates = 1899,                /* -fweak-templates */
  OPT_fweb = 1900,                           /* -fweb */
  /* OPT_fwhole_file = 1901, */              /* -fwhole-file */
  OPT_fwhole_program = 1902,                 /* -fwhole-program */
  OPT_fwholediv = 1903,                      /* -fwholediv */
  OPT_fwholevalue = 1904,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 1905,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1906,             /* -fworking-directory */
  OPT_fwpa = 1907,                           /* -fwpa */
  OPT_fwpa_ = 1908,                          /* -fwpa= */
  OPT_fwrapv = 1909,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1910,                 /* -fwrapv-pointer */
  OPT_fxref = 1911,                          /* -fxref */
  /* OPT_fzee = 1912, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 1913,          /* -fzero-call-used-regs= */
  OPT_fzero_initialized_in_bss = 1914,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1915,                     /* -fzero-link */
  OPT_g = 1916,                              /* -g */
  OPT_gant = 1917,                           /* -gant */
  OPT_gas_loc_support = 1918,                /* -gas-loc-support */
  OPT_gas_locview_support = 1919,            /* -gas-locview-support */
  OPT_gbtf = 1920,                           /* -gbtf */
  OPT_gcodeview = 1921,                      /* -gcodeview */
  OPT_gcoff = 1922,                          /* -gcoff */
  OPT_gcoff1 = 1923,                         /* -gcoff1 */
  OPT_gcoff2 = 1924,                         /* -gcoff2 */
  OPT_gcoff3 = 1925,                         /* -gcoff3 */
  OPT_gcolumn_info = 1926,                   /* -gcolumn-info */
  OPT_gctf = 1927,                           /* -gctf */
  OPT_gdescribe_dies = 1928,                 /* -gdescribe-dies */
  OPT_gdwarf = 1929,                         /* -gdwarf */
  OPT_gdwarf_ = 1930,                        /* -gdwarf- */
  OPT_gdwarf32 = 1931,                       /* -gdwarf32 */
  OPT_gdwarf64 = 1932,                       /* -gdwarf64 */
  OPT_gen_decls = 1933,                      /* -gen-decls */
  OPT_ggdb = 1934,                           /* -ggdb */
  OPT_ggnu_pubnames = 1935,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1936,                   /* -gimple-stats */
  OPT_ginline_points = 1937,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1938, /* -ginternal-reset-location-views */
  OPT_gnat = 1939,                           /* -gnat */
  OPT_gnatO = 1940,                          /* -gnatO */
  OPT_gno_ = 1941,                           /* -gno- */
  OPT_gno_pubnames = 1942,                   /* -gno-pubnames */
  OPT_gprune_btf = 1943,                     /* -gprune-btf */
  OPT_gpubnames = 1944,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1945,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1946,                   /* -gsplit-dwarf */
  OPT_gstabs = 1947,                         /* -gstabs */
  OPT_gstabs_ = 1948,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1949,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1950,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1951,                        /* -gtoggle */
  OPT_gvariable_location_views = 1952,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1953,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1954,                           /* -gvms */
  OPT_gxcoff = 1955,                         /* -gxcoff */
  OPT_gxcoff_ = 1956,                        /* -gxcoff+ */
  OPT_gz = 1957,                             /* -gz */
  OPT_gz_ = 1958,                            /* -gz= */
  OPT_h = 1959,                              /* -h */
  OPT_help = 1960,                           /* -help */
  OPT_idirafter = 1961,                      /* -idirafter */
  OPT_imacros = 1962,                        /* -imacros */
  OPT_imultiarch = 1963,                     /* -imultiarch */
  OPT_imultilib = 1964,                      /* -imultilib */
  OPT_include = 1965,                        /* -include */
  OPT_iplugindir_ = 1966,                    /* -iplugindir= */
  OPT_iprefix = 1967,                        /* -iprefix */
  OPT_iquote = 1968,                         /* -iquote */
  OPT_isysroot = 1969,                       /* -isysroot */
  OPT_isystem = 1970,                        /* -isystem */
  OPT_iwithprefix = 1971,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1972,              /* -iwithprefixbefore */
  OPT_k8 = 1973,                             /* -k8 */
  OPT_l = 1974,                              /* -l */
  OPT_lang_asm = 1975,                       /* -lang-asm */
  OPT_list = 1976,                           /* -list */
  OPT_mabi_ = 1977,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1978,             /* -mabort-on-noreturn */
  OPT_mandroid = 1979,                       /* -mandroid */
  OPT_mapcs = 1980,                          /* -mapcs */
  OPT_mapcs_frame = 1981,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1982,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1983,              /* -mapcs-stack-check */
  OPT_march_ = 1984,                         /* -march= */
  OPT_marm = 1985,                           /* -marm */
  OPT_masm_syntax_unified = 1986,            /* -masm-syntax-unified */
  OPT_mbe32 = 1987,                          /* -mbe32 */
  OPT_mbe8 = 1988,                           /* -mbe8 */
  OPT_mbig_endian = 1989,                    /* -mbig-endian */
  OPT_mbionic = 1990,                        /* -mbionic */
  OPT_mbranch_cost_ = 1991,                  /* -mbranch-cost= */
  OPT_mbranch_protection_ = 1992,            /* -mbranch-protection= */
  OPT_mcallee_super_interworking = 1993,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1994,     /* -mcaller-super-interworking */
  OPT_mcmse = 1995,                          /* -mcmse */
  OPT_mcpu_ = 1996,                          /* -mcpu= */
  OPT_mdlstp = 1997,                         /* -mdlstp */
  OPT_mfdpic = 1998,                         /* -mfdpic */
  OPT_mfix_cmse_cve_2021_35465 = 1999,       /* -mfix-cmse-cve-2021-35465 */
  OPT_mfix_cortex_a57_aes_1742098 = 2000,    /* -mfix-cortex-a57-aes-1742098 */
  /* OPT_mfix_cortex_a72_aes_1655431 = 2001, *//* -mfix-cortex-a72-aes-1655431 */
  OPT_mfix_cortex_m3_ldrd = 2002,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 2003,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 2004,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 2005,                  /* -mfp16-format= */
  OPT_mfpu_ = 2006,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 2007,             /* -mgeneral-regs-only */
  OPT_mglibc = 2008,                         /* -mglibc */
  /* OPT_mhard_float = 2009, */              /* -mhard-float */
  OPT_mlibarch_ = 2010,                      /* -mlibarch= */
  OPT_mlittle_endian = 2011,                 /* -mlittle-endian */
  OPT_mlong_calls = 2012,                    /* -mlong-calls */
  OPT_mmusl = 2013,                          /* -mmusl */
  OPT_mneon_for_64bits = 2014,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 2015,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 2016,                 /* -mpic-register= */
  OPT_mpoke_function_name = 2017,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 2018,               /* -mprint-tune-info */
  OPT_mpure_code = 2019,                     /* -mpure-code */
  OPT_mrestrict_it = 2020,                   /* -mrestrict-it */
  OPT_msched_prolog = 2021,                  /* -msched-prolog */
  OPT_msingle_pic_base = 2022,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 2023,               /* -mslow-flash-data */
  /* OPT_msoft_float = 2024, */              /* -msoft-float */
  OPT_mstack_protector_guard_offset_ = 2025, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_ = 2026,        /* -mstack-protector-guard= */
  OPT_mstructure_size_boundary_ = 2027,      /* -mstructure-size-boundary= */
  OPT_mthumb = 2028,                         /* -mthumb */
  OPT_mthumb_interwork = 2029,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 2030,                  /* -mtls-dialect= */
  OPT_mtp_ = 2031,                           /* -mtp= */
  OPT_mtpcs_frame = 2032,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 2033,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 2034,                         /* -mtune= */
  OPT_muclibc = 2035,                        /* -muclibc */
  OPT_munaligned_access = 2036,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 2037,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 2038,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 2039,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 2040,              /* -mword-relocations */
  OPT_n = 2041,                              /* -n */
  OPT_name_sort = 2042,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2043,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2044,              /* -no-integrated-cpp */
  OPT_no_pie = 2045,                         /* -no-pie */
  OPT_nocpp = 2046,                          /* -nocpp */
  OPT_nodefaultlibs = 2047,                  /* -nodefaultlibs */
  OPT_nolibc = 2048,                         /* -nolibc */
  OPT_nophoboslib = 2049,                    /* -nophoboslib */
  OPT_nostartfiles = 2050,                   /* -nostartfiles */
  OPT_nostdinc = 2051,                       /* -nostdinc */
  OPT_nostdinc__ = 2052,                     /* -nostdinc++ */
  OPT_nostdlib = 2053,                       /* -nostdlib */
  OPT_nostdlib__ = 2054,                     /* -nostdlib++ */
  OPT_o = 2055,                              /* -o */
  OPT_objects = 2056,                        /* -objects */
  OPT_p = 2057,                              /* -p */
  OPT_pass_exit_codes = 2058,                /* -pass-exit-codes */
  /* OPT_pedantic = 2059, */                 /* -pedantic */
  OPT_pedantic_errors = 2060,                /* -pedantic-errors */
  OPT_pg = 2061,                             /* -pg */
  OPT_pie = 2062,                            /* -pie */
  OPT_pipe = 2063,                           /* -pipe */
  OPT_posix = 2064,                          /* -posix */
  OPT_print_file_name_ = 2065,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2066,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2067,          /* -print-multi-directory */
  OPT_print_multi_lib = 2068,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2069,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2070,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2071,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2072,               /* -print-prog-name= */
  OPT_print_search_dirs = 2073,              /* -print-search-dirs */
  OPT_print_sysroot = 2074,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2075,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2076,                    /* -print-value */
  OPT_profile = 2077,                        /* -profile */
  OPT_pthread = 2078,                        /* -pthread */
  OPT_quiet = 2079,                          /* -quiet */
  OPT_r = 2080,                              /* -r */
  OPT_rdynamic = 2081,                       /* -rdynamic */
  ...
  OPT_std_c__26 = 2118,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2119, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2120, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2121, */                /* -std=c++2c */
  OPT_std_c__98 = 2122,                      /* -std=c++98 */
  OPT_std_c11 = 2123,                        /* -std=c11 */
  OPT_std_c17 = 2124,                        /* -std=c17 */
  /* OPT_std_c18 = 2125, */                  /* -std=c18 */
  /* OPT_std_c1x = 2126, */                  /* -std=c1x */
  OPT_std_c23 = 2127,                        /* -std=c23 */
  /* OPT_std_c2x = 2128, */                  /* -std=c2x */
  OPT_std_c2y = 2129,                        /* -std=c2y */
  /* OPT_std_c89 = 2130, */                  /* -std=c89 */
  OPT_std_c90 = 2131,                        /* -std=c90 */
  OPT_std_c99 = 2132,                        /* -std=c99 */
  /* OPT_std_c9x = 2133, */                  /* -std=c9x */
  OPT_std_f2003 = 2134,                      /* -std=f2003 */
  OPT_std_f2008 = 2135,                      /* -std=f2008 */
  OPT_std_f2008ts = 2136,                    /* -std=f2008ts */
  OPT_std_f2018 = 2137,                      /* -std=f2018 */
  OPT_std_f2023 = 2138,                      /* -std=f2023 */
  OPT_std_f95 = 2139,                        /* -std=f95 */
  OPT_std_gnu = 2140,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2141, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2142, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2143,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2144,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2145,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2146, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2147, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2148,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2149,                    /* -std=gnu++23 */
  OPT_std_gnu__26 = 2150,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2151, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2152, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2153, */              /* -std=gnu++2c */
  OPT_std_gnu__98 = 2154,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2155,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2156,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2157, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2158, */                /* -std=gnu1x */
  OPT_std_gnu23 = 2159,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2160, */                /* -std=gnu2x */
  OPT_std_gnu2y = 2161,                      /* -std=gnu2y */
  /* OPT_std_gnu89 = 2162, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2163,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2164,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2165, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2166, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2167,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2168, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2169, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2170, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2171, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2172, */         /* -std=iso9899:2018 */
  /* OPT_std_iso9899_2024 = 2173, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2174,                     /* -std=legacy */
  OPT_stdlib_ = 2175,                        /* -stdlib= */
  OPT_symbol_ = 2176,                        /* -symbol= */
  OPT_symbolic = 2177,                       /* -symbolic */
  OPT_t = 2178,                              /* -t */
  OPT_time = 2179,                           /* -time */
  OPT_time_ = 2180,                          /* -time= */
  OPT_tno_android_cc = 2181,                 /* -tno-android-cc */
  OPT_tno_android_ld = 2182,                 /* -tno-android-ld */
  OPT_traditional = 2183,                    /* -traditional */
  OPT_traditional_cpp = 2184,                /* -traditional-cpp */
  OPT_tree_stats = 2185,                     /* -tree-stats */
  OPT_trigraphs = 2186,                      /* -trigraphs */
  OPT_truncate = 2187,                       /* -truncate */
  OPT_type_stats = 2188,                     /* -type-stats */
  OPT_u = 2189,                              /* -u */
  OPT_undef = 2190,                          /* -undef */
  OPT_v = 2191,                              /* -v */
  OPT_version = 2192,                        /* -version */
  OPT_w = 2193,                              /* -w */
  OPT_wrapper = 2194,                        /* -wrapper */
  OPT_x = 2195,                              /* -x */
  OPT_z = 2196,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
