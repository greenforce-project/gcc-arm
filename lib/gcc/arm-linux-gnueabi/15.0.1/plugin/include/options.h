...
#endif
#ifdef GENERATOR_FILE
extern const char *cobol_include;
#else
  const char *x_cobol_include;
#define cobol_include global_options.x_cobol_include
#endif
#ifdef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT__param_max_combine_search_insns_ = 189,/* --param=max-combine-search-insns= */
  OPT__param_max_completely_peel_loop_nest_depth_ = 190,/* --param=max-completely-peel-loop-nest-depth= */
  OPT__param_max_completely_peel_times_ = 191,/* --param=max-completely-peel-times= */
  OPT__param_max_completely_peeled_insns_ = 192,/* --param=max-completely-peeled-insns= */
  OPT__param_max_crossjump_edges_ = 193,     /* --param=max-crossjump-edges= */
  OPT__param_max_cse_insns_ = 194,           /* --param=max-cse-insns= */
  OPT__param_max_cse_path_length_ = 195,     /* --param=max-cse-path-length= */
  OPT__param_max_cselib_memory_locations_ = 196,/* --param=max-cselib-memory-locations= */
  OPT__param_max_debug_marker_count_ = 197,  /* --param=max-debug-marker-count= */
  OPT__param_max_delay_slot_insn_search_ = 198,/* --param=max-delay-slot-insn-search= */
  OPT__param_max_delay_slot_live_search_ = 199,/* --param=max-delay-slot-live-search= */
  OPT__param_max_dse_active_local_stores_ = 200,/* --param=max-dse-active-local-stores= */
  OPT__param_max_early_inliner_iterations_ = 201,/* --param=max-early-inliner-iterations= */
  OPT__param_max_fields_for_field_sensitive_ = 202,/* --param=max-fields-for-field-sensitive= */
  OPT__param_max_find_base_term_values_ = 203,/* --param=max-find-base-term-values= */
  OPT__param_max_fsm_thread_path_insns_ = 204,/* --param=max-fsm-thread-path-insns= */
  OPT__param_max_gcse_insertion_ratio_ = 205,/* --param=max-gcse-insertion-ratio= */
  OPT__param_max_gcse_memory_ = 206,         /* --param=max-gcse-memory= */
  OPT__param_max_goto_duplication_insns_ = 207,/* --param=max-goto-duplication-insns= */
  OPT__param_max_grow_copy_bb_insns_ = 208,  /* --param=max-grow-copy-bb-insns= */
  OPT__param_max_hoist_depth_ = 209,         /* --param=max-hoist-depth= */
  OPT__param_max_inline_functions_called_once_insns_ = 210,/* --param=max-inline-functions-called-once-insns= */
  OPT__param_max_inline_functions_called_once_loop_depth_ = 211,/* --param=max-inline-functions-called-once-loop-depth= */
  OPT__param_max_inline_insns_auto_ = 212,   /* --param=max-inline-insns-auto= */
  OPT__param_max_inline_insns_recursive_auto_ = 213,/* --param=max-inline-insns-recursive-auto= */
  OPT__param_max_inline_insns_recursive_ = 214,/* --param=max-inline-insns-recursive= */
  OPT__param_max_inline_insns_single_ = 215, /* --param=max-inline-insns-single= */
  OPT__param_max_inline_insns_size_ = 216,   /* --param=max-inline-insns-size= */
  OPT__param_max_inline_insns_small_ = 217,  /* --param=max-inline-insns-small= */
  OPT__param_max_inline_recursive_depth_auto_ = 218,/* --param=max-inline-recursive-depth-auto= */
  OPT__param_max_inline_recursive_depth_ = 219,/* --param=max-inline-recursive-depth= */
  OPT__param_max_isl_operations_ = 220,      /* --param=max-isl-operations= */
  OPT__param_max_iterations_computation_cost_ = 221,/* --param=max-iterations-computation-cost= */
  OPT__param_max_iterations_to_track_ = 222, /* --param=max-iterations-to-track= */
  OPT__param_max_jump_thread_duplication_stmts_ = 223,/* --param=max-jump-thread-duplication-stmts= */
  OPT__param_max_jump_thread_paths_ = 224,   /* --param=max-jump-thread-paths= */
  OPT__param_max_last_value_rtl_ = 225,      /* --param=max-last-value-rtl= */
  OPT__param_max_loop_header_insns_ = 226,   /* --param=max-loop-header-insns= */
  OPT__param_max_modulo_backtrack_attempts_ = 227,/* --param=max-modulo-backtrack-attempts= */
  OPT__param_max_partial_antic_length_ = 228,/* --param=max-partial-antic-length= */
  OPT__param_max_peel_branches_ = 229,       /* --param=max-peel-branches= */
  OPT__param_max_peel_times_ = 230,          /* --param=max-peel-times= */
  OPT__param_max_peeled_insns_ = 231,        /* --param=max-peeled-insns= */
  OPT__param_max_pending_list_length_ = 232, /* --param=max-pending-list-length= */
  OPT__param_max_pipeline_region_blocks_ = 233,/* --param=max-pipeline-region-blocks= */
  OPT__param_max_pipeline_region_insns_ = 234,/* --param=max-pipeline-region-insns= */
  OPT__param_max_pow_sqrt_depth_ = 235,      /* --param=max-pow-sqrt-depth= */
  OPT__param_max_predicted_iterations_ = 236,/* --param=max-predicted-iterations= */
  OPT__param_max_reload_search_insns_ = 237, /* --param=max-reload-search-insns= */
  OPT__param_max_rtl_if_conversion_insns_ = 238,/* --param=max-rtl-if-conversion-insns= */
  OPT__param_max_rtl_if_conversion_predictable_cost_ = 239,/* --param=max-rtl-if-conversion-predictable-cost= */
  OPT__param_max_rtl_if_conversion_unpredictable_cost_ = 240,/* --param=max-rtl-if-conversion-unpredictable-cost= */
  OPT__param_max_sched_extend_regions_iters_ = 241,/* --param=max-sched-extend-regions-iters= */
  OPT__param_max_sched_insn_conflict_delay_ = 242,/* --param=max-sched-insn-conflict-delay= */
  OPT__param_max_sched_ready_insns_ = 243,   /* --param=max-sched-ready-insns= */
  OPT__param_max_sched_region_blocks_ = 244, /* --param=max-sched-region-blocks= */
  OPT__param_max_sched_region_insns_ = 245,  /* --param=max-sched-region-insns= */
  OPT__param_max_slsr_cand_scan_ = 246,      /* --param=max-slsr-cand-scan= */
  OPT__param_max_speculative_devirt_maydefs_ = 247,/* --param=max-speculative-devirt-maydefs= */
  OPT__param_max_ssa_name_query_depth_ = 248,/* --param=max-ssa-name-query-depth= */
  OPT__param_max_store_chains_to_track_ = 249,/* --param=max-store-chains-to-track= */
  OPT__param_max_stores_to_merge_ = 250,     /* --param=max-stores-to-merge= */
  OPT__param_max_stores_to_sink_ = 251,      /* --param=max-stores-to-sink= */
  OPT__param_max_stores_to_track_ = 252,     /* --param=max-stores-to-track= */
  OPT__param_max_tail_merge_comparisons_ = 253,/* --param=max-tail-merge-comparisons= */
  OPT__param_max_tail_merge_iterations_ = 254,/* --param=max-tail-merge-iterations= */
  OPT__param_max_tracked_strlens_ = 255,     /* --param=max-tracked-strlens= */
  OPT__param_max_tree_if_conversion_phi_args_ = 256,/* --param=max-tree-if-conversion-phi-args= */
  OPT__param_max_unroll_times_ = 257,        /* --param=max-unroll-times= */
  OPT__param_max_unrolled_insns_ = 258,      /* --param=max-unrolled-insns= */
  OPT__param_max_unswitch_depth_ = 259,      /* --param=max-unswitch-depth= */
  OPT__param_max_unswitch_insns_ = 260,      /* --param=max-unswitch-insns= */
  OPT__param_max_variable_expansions_in_unroller_ = 261,/* --param=max-variable-expansions-in-unroller= */
  OPT__param_max_vartrack_expr_depth_ = 262, /* --param=max-vartrack-expr-depth= */
  OPT__param_max_vartrack_reverse_op_size_ = 263,/* --param=max-vartrack-reverse-op-size= */
  OPT__param_max_vartrack_size_ = 264,       /* --param=max-vartrack-size= */
  OPT__param_min_crossjump_insns_ = 265,     /* --param=min-crossjump-insns= */
  OPT__param_min_inline_recursive_probability_ = 266,/* --param=min-inline-recursive-probability= */
  OPT__param_min_insn_to_prefetch_ratio_ = 267,/* --param=min-insn-to-prefetch-ratio= */
  OPT__param_min_loop_cond_split_prob_ = 268,/* --param=min-loop-cond-split-prob= */
  OPT__param_min_nondebug_insn_uid_ = 269,   /* --param=min-nondebug-insn-uid= */
  OPT__param_min_pagesize_ = 270,            /* --param=min-pagesize= */
  OPT__param_min_size_for_stack_sharing_ = 271,/* --param=min-size-for-stack-sharing= */
  OPT__param_min_spec_prob_ = 272,           /* --param=min-spec-prob= */
  OPT__param_min_vect_loop_bound_ = 273,     /* --param=min-vect-loop-bound= */
  OPT__param_modref_max_accesses_ = 274,     /* --param=modref-max-accesses= */
  OPT__param_modref_max_adjustments_ = 275,  /* --param=modref-max-adjustments= */
  OPT__param_modref_max_bases_ = 276,        /* --param=modref-max-bases= */
  OPT__param_modref_max_depth_ = 277,        /* --param=modref-max-depth= */
  OPT__param_modref_max_escape_points_ = 278,/* --param=modref-max-escape-points= */
  OPT__param_modref_max_refs_ = 279,         /* --param=modref-max-refs= */
  OPT__param_modref_max_tests_ = 280,        /* --param=modref-max-tests= */
  OPT__param_openacc_kernels_ = 281,         /* --param=openacc-kernels= */
  OPT__param_openacc_privatization_ = 282,   /* --param=openacc-privatization= */
  OPT__param_parloops_chunk_size_ = 283,     /* --param=parloops-chunk-size= */
  OPT__param_parloops_min_per_thread_ = 284, /* --param=parloops-min-per-thread= */
  OPT__param_parloops_schedule_ = 285,       /* --param=parloops-schedule= */
  OPT__param_partial_inlining_entry_probability_ = 286,/* --param=partial-inlining-entry-probability= */
  OPT__param_phiopt_factor_max_stmts_live_ = 287,/* --param=phiopt-factor-max-stmts-live= */
  ...
  OPT__param_store_forwarding_max_distance_ = 323,/* --param=store-forwarding-max-distance= */
  OPT__param_store_merging_allow_unaligned_ = 324,/* --param=store-merging-allow-unaligned= */
  OPT__param_store_merging_max_size_ = 325,  /* --param=store-merging-max-size= */
  OPT__param_switch_conversion_max_branch_ratio_ = 326,/* --param=switch-conversion-max-branch-ratio= */
  OPT__param_switch_lower_slow_alg_max_cases_ = 327,/* --param=switch-lower-slow-alg-max-cases= */
  ...
  OPT__param_transitive_relations_work_bound_ = 336,/* --param=transitive-relations-work-bound= */
  OPT__param_tree_reassoc_width_ = 337,      /* --param=tree-reassoc-width= */
  OPT__param_tsan_distinguish_volatile_ = 338,/* --param=tsan-distinguish-volatile= */
  OPT__param_tsan_instrument_func_entry_exit_ = 339,/* --param=tsan-instrument-func-entry-exit= */
  OPT__param_uninit_control_dep_attempts_ = 340,/* --param=uninit-control-dep-attempts= */
  OPT__param_uninit_max_chain_len_ = 341,    /* --param=uninit-max-chain-len= */
  OPT__param_uninit_max_num_chains_ = 342,   /* --param=uninit-max-num-chains= */
  OPT__param_uninlined_function_insns_ = 343,/* --param=uninlined-function-insns= */
  OPT__param_uninlined_function_time_ = 344, /* --param=uninlined-function-time= */
  OPT__param_uninlined_thunk_insns_ = 345,   /* --param=uninlined-thunk-insns= */
  OPT__param_uninlined_thunk_time_ = 346,    /* --param=uninlined-thunk-time= */
  OPT__param_unlikely_bb_count_fraction_ = 347,/* --param=unlikely-bb-count-fraction= */
  OPT__param_unroll_jam_max_unroll_ = 348,   /* --param=unroll-jam-max-unroll= */
  OPT__param_unroll_jam_min_percent_ = 349,  /* --param=unroll-jam-min-percent= */
  OPT__param_use_after_scope_direct_emission_threshold_ = 350,/* --param=use-after-scope-direct-emission-threshold= */
  OPT__param_use_canonical_types_ = 351,     /* --param=use-canonical-types= */
  OPT__param_vect_epilogues_nomask_ = 352,   /* --param=vect-epilogues-nomask= */
  OPT__param_vect_force_slp_ = 353,          /* --param=vect-force-slp= */
  OPT__param_vect_induction_float_ = 354,    /* --param=vect-induction-float= */
  OPT__param_vect_inner_loop_cost_factor_ = 355,/* --param=vect-inner-loop-cost-factor= */
  OPT__param_vect_max_layout_candidates_ = 356,/* --param=vect-max-layout-candidates= */
  OPT__param_vect_max_peeling_for_alignment_ = 357,/* --param=vect-max-peeling-for-alignment= */
  OPT__param_vect_max_version_for_alias_checks_ = 358,/* --param=vect-max-version-for-alias-checks= */
  OPT__param_vect_max_version_for_alignment_checks_ = 359,/* --param=vect-max-version-for-alignment-checks= */
  OPT__param_vect_partial_vector_usage_ = 360,/* --param=vect-partial-vector-usage= */
  OPT__param_vrp_block_limit_ = 361,         /* --param=vrp-block-limit= */
  ...
  OPT_Wc23_c2y_compat = 564,                 /* -Wc23-c2y-compat */
  OPT_Wc90_c99_compat = 565,                 /* -Wc90-c99-compat */
  OPT_Wc99_c11_compat = 566,                 /* -Wc99-c11-compat */
  OPT_Wcalloc_transposed_args = 567,         /* -Wcalloc-transposed-args */
  OPT_Wcannot_profile = 568,                 /* -Wcannot-profile */
  OPT_Wcase_enum = 569,                      /* -Wcase-enum */
  OPT_Wcast_align = 570,                     /* -Wcast-align */
  OPT_Wcast_align_strict = 571,              /* -Wcast-align=strict */
  OPT_Wcast_function_type = 572,             /* -Wcast-function-type */
  OPT_Wcast_qual = 573,                      /* -Wcast-qual */
  OPT_Wcast_result = 574,                    /* -Wcast-result */
  OPT_Wcast_user_defined = 575,              /* -Wcast-user-defined */
  /* OPT_Wcatch_value = 576, */              /* -Wcatch-value */
  OPT_Wcatch_value_ = 577,                   /* -Wcatch-value= */
  OPT_Wchanges_meaning = 578,                /* -Wchanges-meaning */
  OPT_Wchar_subscripts = 579,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 580,           /* -Wcharacter-truncation */
  OPT_Wchkp = 581,                           /* -Wchkp */
  OPT_Wclass_conversion = 582,               /* -Wclass-conversion */
  OPT_Wclass_memaccess = 583,                /* -Wclass-memaccess */
  OPT_Wclobbered = 584,                      /* -Wclobbered */
  OPT_Wcomma_subscript = 585,                /* -Wcomma-subscript */
  OPT_Wcomment = 586,                        /* -Wcomment */
  /* OPT_Wcomments = 587, */                 /* -Wcomments */
  OPT_Wcompare_distinct_pointer_types = 588, /* -Wcompare-distinct-pointer-types */
  OPT_Wcompare_reals = 589,                  /* -Wcompare-reals */
  OPT_Wcomplain_wrong_lang = 590,            /* -Wcomplain-wrong-lang */
  OPT_Wconditionally_supported = 591,        /* -Wconditionally-supported */
  OPT_Wconversion = 592,                     /* -Wconversion */
  OPT_Wconversion_extra = 593,               /* -Wconversion-extra */
  OPT_Wconversion_null = 594,                /* -Wconversion-null */
  OPT_Wcoverage_invalid_line_number = 595,   /* -Wcoverage-invalid-line-number */
  OPT_Wcoverage_mismatch = 596,              /* -Wcoverage-mismatch */
  OPT_Wcoverage_too_many_conditions = 597,   /* -Wcoverage-too-many-conditions */
  OPT_Wcoverage_too_many_paths = 598,        /* -Wcoverage-too-many-paths */
  OPT_Wcpp = 599,                            /* -Wcpp */
  ...
  OPT_Wmain = 716,                           /* -Wmain */
  OPT_Wmaybe_musttail_local_addr = 717,      /* -Wmaybe-musttail-local-addr */
  ...
  OPT_Wmissing_parameter_name = 733,         /* -Wmissing-parameter-name */
  OPT_Wmissing_parameter_type = 734,         /* -Wmissing-parameter-type */
  OPT_Wmissing_profile = 735,                /* -Wmissing-profile */
  OPT_Wmissing_prototypes = 736,             /* -Wmissing-prototypes */
  OPT_Wmissing_requires = 737,               /* -Wmissing-requires */
  OPT_Wmissing_template_keyword = 738,       /* -Wmissing-template-keyword */
  OPT_Wmissing_variable_declarations = 739,  /* -Wmissing-variable-declarations */
  OPT_Wmudflap = 740,                        /* -Wmudflap */
  OPT_Wmultichar = 741,                      /* -Wmultichar */
  OPT_Wmultiple_inheritance = 742,           /* -Wmultiple-inheritance */
  OPT_Wmultistatement_macros = 743,          /* -Wmultistatement-macros */
  OPT_Wmusttail_local_addr = 744,            /* -Wmusttail-local-addr */
  OPT_Wnamespaces = 745,                     /* -Wnamespaces */
  OPT_Wnarrowing = 746,                      /* -Wnarrowing */
  OPT_Wnested_externs = 747,                 /* -Wnested-externs */
  /* OPT_Wno_alloc_size_larger_than = 748, *//* -Wno-alloc-size-larger-than */
  /* OPT_Wno_alloca_larger_than = 749, */    /* -Wno-alloca-larger-than */
  /* OPT_Wno_frame_larger_than = 750, */     /* -Wno-frame-larger-than */
  /* OPT_Wno_larger_than = 751, */           /* -Wno-larger-than */
  /* OPT_Wno_stack_usage = 752, */           /* -Wno-stack-usage */
  /* OPT_Wno_vla_larger_than = 753, */       /* -Wno-vla-larger-than */
  OPT_Wnoexcept = 754,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 755,                  /* -Wnoexcept-type */
  OPT_Wnon_template_friend = 756,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 757,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 758,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 759,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 760, */               /* -Wnormalized */
  OPT_Wnormalized_ = 761,                    /* -Wnormalized= */
  OPT_Wnrvo = 762,                           /* -Wnrvo */
  OPT_Wnull_dereference = 763,               /* -Wnull-dereference */
  OPT_Wobjc_root_class = 764,                /* -Wobjc-root-class */
  OPT_Wodr = 765,                            /* -Wodr */
  OPT_Wold_style_cast = 766,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 767,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 768,           /* -Wold-style-definition */
  OPT_Wopenacc_parallelism = 769,            /* -Wopenacc-parallelism */
  OPT_Wopenmp = 770,                         /* -Wopenmp */
  OPT_Wopenmp_simd = 771,                    /* -Wopenmp-simd */
  OPT_Woverflow = 772,                       /* -Woverflow */
  OPT_Woverlength_strings = 773,             /* -Woverlength-strings */
  /* OPT_Woverloaded_virtual = 774, */       /* -Woverloaded-virtual */
  OPT_Woverloaded_virtual_ = 775,            /* -Woverloaded-virtual= */
  OPT_Woverride_init = 776,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 777,     /* -Woverride-init-side-effects */
  OPT_Woverwrite_recursive = 778,            /* -Woverwrite-recursive */
  OPT_Wp_ = 779,                             /* -Wp, */
  OPT_Wpacked = 780,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 781,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 782,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 783,                         /* -Wpadded */
  OPT_Wparentheses = 784,                    /* -Wparentheses */
  OPT_Wpedantic = 785,                       /* -Wpedantic */
  OPT_Wpedantic_cast = 786,                  /* -Wpedantic-cast */
  OPT_Wpedantic_param_names = 787,           /* -Wpedantic-param-names */
  OPT_Wpessimizing_move = 788,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 789, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 790,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 791,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 792,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 793,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 794,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 795,            /* -Wpointer-to-int-cast */
  OPT_Wpragma_once_outside_header = 796,     /* -Wpragma-once-outside-header */
  OPT_Wpragmas = 797,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 798,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 799,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 800,                       /* -Wprotocol */
  OPT_Wpsabi = 801,                          /* -Wpsabi */
  OPT_Wrange_loop_construct = 802,           /* -Wrange-loop-construct */
  OPT_Wreal_q_constant = 803,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 804,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 805,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 806,                /* -Wredundant-decls */
  OPT_Wredundant_move = 807,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 808,                 /* -Wredundant-tags */
  OPT_Wregister = 809,                       /* -Wregister */
  OPT_Wreorder = 810,                        /* -Wreorder */
  OPT_Wrestrict = 811,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 812,              /* -Wreturn-local-addr */
  OPT_Wreturn_mismatch = 813,                /* -Wreturn-mismatch */
  OPT_Wreturn_type = 814,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 815,           /* -Wscalar-storage-order */
  OPT_Wselector = 816,                       /* -Wselector */
  OPT_Wself_move = 817,                      /* -Wself-move */
  OPT_Wsequence_point = 818,                 /* -Wsequence-point */
  OPT_Wshadow = 819,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 820, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 821,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 822, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 823,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 824, */            /* -Wshadow=global */
  OPT_Wshadow_local = 825,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 826,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 827,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 828,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 829, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 830,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 831,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 832,                /* -Wsign-conversion */
  OPT_Wsign_promo = 833,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 834,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 835,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_array_div = 836,               /* -Wsizeof-array-div */
  OPT_Wsizeof_pointer_div = 837,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 838,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 839,                    /* -Wspeculative */
  OPT_Wstack_protector = 840,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 841,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 842,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 843,               /* -Wstrict-aliasing= */
  OPT_Wstrict_flex_arrays = 844,             /* -Wstrict-flex-arrays */
  OPT_Wstrict_null_sentinel = 845,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 846,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 847,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 848,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 849,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 850,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 851, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 852,             /* -Wstringop-overflow= */
  OPT_Wstringop_overread = 853,              /* -Wstringop-overread */
  OPT_Wstringop_truncation = 854,            /* -Wstringop-truncation */
  OPT_Wstyle = 855,                          /* -Wstyle */
  OPT_Wsubobject_linkage = 856,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 857,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 858,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 859,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 860,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 861,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 862,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_attribute_returns_nonnull = 863,/* -Wsuggest-attribute=returns_nonnull */
  OPT_Wsuggest_final_methods = 864,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 865,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 866,               /* -Wsuggest-override */
  OPT_Wsurprising = 867,                     /* -Wsurprising */
  OPT_Wswitch = 868,                         /* -Wswitch */
  OPT_Wswitch_bool = 869,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 870,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 871,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 872,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 873,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 874,                      /* -Wsync-nand */
  OPT_Wsynth = 875,                          /* -Wsynth */
  OPT_Wsystem_headers = 876,                 /* -Wsystem-headers */
  OPT_Wtabs = 877,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 878,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 879,           /* -Wtautological-compare */
  OPT_Wtemplate_body = 880,                  /* -Wtemplate-body */
  OPT_Wtemplate_id_cdtor = 881,              /* -Wtemplate-id-cdtor */
  OPT_Wtemplate_names_tu_local = 882,        /* -Wtemplate-names-tu-local */
  OPT_Wtemplates = 883,                      /* -Wtemplates */
  OPT_Wterminate = 884,                      /* -Wterminate */
  OPT_Wtraditional = 885,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 886,         /* -Wtraditional-conversion */
  /* OPT_Wtrailing_whitespace = 887, */      /* -Wtrailing-whitespace */
  OPT_Wtrailing_whitespace_ = 888,           /* -Wtrailing-whitespace= */
  OPT_Wtrampolines = 889,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 890,                      /* -Wtrigraphs */
  OPT_Wtrivial_auto_var_init = 891,          /* -Wtrivial-auto-var-init */
  OPT_Wtsan = 892,                           /* -Wtsan */
  OPT_Wtype_limits = 893,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 894,            /* -Wundeclared-selector */
  OPT_Wundef = 895,                          /* -Wundef */
  OPT_Wundefined_do_loop = 896,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 897,                      /* -Wunderflow */
  OPT_Wunicode = 898,                        /* -Wunicode */
  OPT_Wuninit_variable_checking = 899,       /* -Wuninit-variable-checking */
  OPT_Wuninit_variable_checking_ = 900,      /* -Wuninit-variable-checking= */
  OPT_Wuninitialized = 901,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 902,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 903, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 904, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 905,     /* -Wunsuffixed-float-constants */
  OPT_Wunterminated_string_initialization = 906,/* -Wunterminated-string-initialization */
  OPT_Wunused = 907,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 908,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 909,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 910, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 911,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 912,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 913,                /* -Wunused-function */
  OPT_Wunused_label = 914,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 915,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 916,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 917,               /* -Wunused-parameter */
  OPT_Wunused_result = 918,                  /* -Wunused-result */
  OPT_Wunused_value = 919,                   /* -Wunused-value */
  OPT_Wunused_variable = 920,                /* -Wunused-variable */
  OPT_Wuse_after_free = 921,                 /* -Wuse-after-free */
  OPT_Wuse_after_free_ = 922,                /* -Wuse-after-free= */
  OPT_Wuse_without_only = 923,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 924,                   /* -Wuseless-cast */
  OPT_Wvarargs = 925,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 926,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 927,   /* -Wvector-operation-performance */
  OPT_Wverbose_unbounded = 928,              /* -Wverbose-unbounded */
  OPT_Wvexing_parse = 929,                   /* -Wvexing-parse */
  OPT_Wvirtual_inheritance = 930,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 931,            /* -Wvirtual-move-assign */
  OPT_Wvla = 932,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 933,               /* -Wvla-larger-than= */
  OPT_Wvla_parameter = 934,                  /* -Wvla-parameter */
  OPT_Wvolatile = 935,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 936,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 937,                  /* -Wwrite-strings */
  OPT_Wxor_used_as_pow = 938,                /* -Wxor-used-as-pow */
  OPT_Wzero_as_null_pointer_constant = 939,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 940,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 941,                       /* -Wzerotrip */
  OPT_X = 942,                               /* -X */
  OPT_Xassembler = 943,                      /* -Xassembler */
  OPT_Xf = 944,                              /* -Xf */
  OPT_Xlinker = 945,                         /* -Xlinker */
  OPT_Xpreprocessor = 946,                   /* -Xpreprocessor */
  OPT_Z = 947,                               /* -Z */
  OPT_ansi = 948,                            /* -ansi */
  OPT_aux_info = 949,                        /* -aux-info */
  /* OPT_aux_info_ = 950, */                 /* -aux-info= */
  OPT_c = 951,                               /* -c */
  OPT_callgraph = 952,                       /* -callgraph */
  OPT_copyext = 953,                         /* -copyext */
  OPT_coverage = 954,                        /* -coverage */
  OPT_cpp = 955,                             /* -cpp */
  OPT_cpp_ = 956,                            /* -cpp= */
  OPT_d = 957,                               /* -d */
  OPT_debuglib_ = 958,                       /* -debuglib= */
  OPT_defaultlib_ = 959,                     /* -defaultlib= */
  OPT_defined_only = 960,                    /* -defined-only */
  OPT_demangle = 961,                        /* -demangle */
  OPT_dialect = 962,                         /* -dialect */
  OPT_dstartfiles = 963,                     /* -dstartfiles */
  OPT_dump_body_ = 964,                      /* -dump-body= */
  OPT_dump_level_ = 965,                     /* -dump-level= */
  OPT_dumpbase = 966,                        /* -dumpbase */
  OPT_dumpbase_ext = 967,                    /* -dumpbase-ext */
  OPT_dumpdir = 968,                         /* -dumpdir */
  OPT_dumpfullversion = 969,                 /* -dumpfullversion */
  OPT_dumpmachine = 970,                     /* -dumpmachine */
  OPT_dumpspecs = 971,                       /* -dumpspecs */
  OPT_dumpversion = 972,                     /* -dumpversion */
  OPT_e = 973,                               /* -e */
  OPT_export_dynamic = 974,                  /* -export-dynamic */
  OPT_fPIC = 975,                            /* -fPIC */
  OPT_fPIE = 976,                            /* -fPIE */
  OPT_fRTS_ = 977,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 978,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 979,                   /* -fabi-version= */
  OPT_faccess_control = 980,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 981,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 982,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 983,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 984,                  /* -falign-commons */
  OPT_falign_functions = 985,                /* -falign-functions */
  OPT_falign_functions_ = 986,               /* -falign-functions= */
  OPT_falign_jumps = 987,                    /* -falign-jumps */
  OPT_falign_jumps_ = 988,                   /* -falign-jumps= */
  OPT_falign_labels = 989,                   /* -falign-labels */
  OPT_falign_labels_ = 990,                  /* -falign-labels= */
  OPT_falign_loops = 991,                    /* -falign-loops */
  OPT_falign_loops_ = 992,                   /* -falign-loops= */
  /* OPT_faligned_new = 993, */              /* -faligned-new */
  OPT_faligned_new_ = 994,                   /* -faligned-new= */
  OPT_fall_instantiations = 995,             /* -fall-instantiations */
  OPT_fall_intrinsics = 996,                 /* -fall-intrinsics */
  OPT_fall_virtual = 997,                    /* -fall-virtual */
  OPT_fallocation_dce = 998,                 /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 999,        /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 1000,             /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 1001,      /* -fallow-leading-underscore */
  /* OPT_fallow_parameterless_variadic_functions = 1002, *//* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 1003,        /* -fallow-store-data-races */
  OPT_falt_external_templates = 1004,        /* -falt-external-templates */
  OPT_fanalyzer = 1005,                      /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 1006,       /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 1007,             /* -fanalyzer-checker= */
  OPT_fanalyzer_debug_text_art = 1008,       /* -fanalyzer-debug-text-art */
  OPT_fanalyzer_feasibility = 1009,          /* -fanalyzer-feasibility */
  OPT_fanalyzer_fine_grained = 1010,         /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 1011, /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_show_events_in_system_headers = 1012,/* -fanalyzer-show-events-in-system-headers */
  OPT_fanalyzer_state_merge = 1013,          /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 1014,          /* -fanalyzer-state-purge */
  OPT_fanalyzer_suppress_followups = 1015,   /* -fanalyzer-suppress-followups */
  OPT_fanalyzer_transitivity = 1016,         /* -fanalyzer-transitivity */
  OPT_fanalyzer_undo_inlining = 1017,        /* -fanalyzer-undo-inlining */
  OPT_fanalyzer_verbose_edges = 1018,        /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 1019,/* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 1020,           /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 1021, */          /* -fargument-alias */
  /* OPT_fargument_noalias = 1022, */        /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 1023, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 1024, */ /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 1025,           /* -fasan-shadow-offset= */
  OPT_fasm = 1026,                           /* -fasm */
  OPT_fassert = 1027,                        /* -fassert */
  OPT_fassociative_math = 1028,              /* -fassociative-math */
  OPT_fassume_sane_operators_new_delete = 1029,/* -fassume-sane-operators-new-delete */
  OPT_fasynchronous_unwind_tables = 1030,    /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 1031,                  /* -fauto-inc-dec */
  OPT_fauto_init = 1032,                     /* -fauto-init */
  OPT_fauto_profile = 1033,                  /* -fauto-profile */
  OPT_fauto_profile_ = 1034,                 /* -fauto-profile= */
  OPT_fautomatic = 1035,                     /* -fautomatic */
  OPT_favoid_store_forwarding = 1036,        /* -favoid-store-forwarding */
  OPT_fbackslash = 1037,                     /* -fbackslash */
  OPT_fbacktrace = 1038,                     /* -fbacktrace */
  OPT_fbit_tests = 1039,                     /* -fbit-tests */
  OPT_fblas_matmul_limit_ = 1040,            /* -fblas-matmul-limit= */
  OPT_fbounds = 1041,                        /* -fbounds */
  OPT_fbounds_check = 1042,                  /* -fbounds-check */
  OPT_fbounds_check_ = 1043,                 /* -fbounds-check= */
  OPT_fbranch_count_reg = 1044,              /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 1045,          /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 1046, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 1047, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 1048, */        /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 1049,               /* -fbuilding-libgcc */
  OPT_fbuilding_libgfortran = 1050,          /* -fbuilding-libgfortran */
  OPT_fbuilding_libphobos_tests = 1051,      /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 1052,                       /* -fbuiltin */
  OPT_fbuiltin_ = 1053,                      /* -fbuiltin- */
  OPT_fbuiltin_printf = 1054,                /* -fbuiltin-printf */
  OPT_fc_prototypes = 1055,                  /* -fc-prototypes */
  OPT_fc_prototypes_external = 1056,         /* -fc-prototypes-external */
  OPT_fcall_saved_ = 1057,                   /* -fcall-saved- */
  OPT_fcall_used_ = 1058,                    /* -fcall-used- */
  OPT_fcaller_saves = 1059,                  /* -fcaller-saves */
  OPT_fcallgraph_info = 1060,                /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 1061,               /* -fcallgraph-info= */
  OPT_fcanon_prefix_map = 1062,              /* -fcanon-prefix-map */
  OPT_fcanonical_system_headers = 1063,      /* -fcanonical-system-headers */
  OPT_fcase = 1064,                          /* -fcase */
  /* OPT_fcf_protection = 1065, */           /* -fcf-protection */
  OPT_fcf_protection_ = 1066,                /* -fcf-protection= */
  OPT_fchar8_t = 1067,                       /* -fchar8_t */
  OPT_fcheck_array_temporaries = 1068,       /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 1069, */         /* -fcheck-data-deps */
  OPT_fcheck_new = 1070,                     /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 1071,          /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 1072,                        /* -fcheck= */
  /* OPT_fcheck_assert = 1073, */            /* -fcheck=assert */
  /* OPT_fcheck_bounds = 1074, */            /* -fcheck=bounds */
  /* OPT_fcheck_in = 1075, */                /* -fcheck=in */
  /* OPT_fcheck_invariant = 1076, */         /* -fcheck=invariant */
  /* OPT_fcheck_out = 1077, */               /* -fcheck=out */
  /* OPT_fcheck_switch = 1078, */            /* -fcheck=switch */
  OPT_fcheckaction_ = 1079,                  /* -fcheckaction= */
  OPT_fchecking = 1080,                      /* -fchecking */
  OPT_fchecking_ = 1081,                     /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 1082,    /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 1083,               /* -fchkp-check-read */
  OPT_fchkp_check_write = 1084,              /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 1085,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 1086,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 1087,         /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 1088,   /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 1089,            /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 1090,/* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 1091,                 /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 1092,             /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 1093,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 1094,/* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 1095,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 1096,        /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 1097,  /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 1098,             /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 1099,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 1100, */                /* -fcilkplus */
  OPT_fcoarray_ = 1101,                      /* -fcoarray= */
  OPT_fcobol_exceptions = 1102,              /* -fcobol-exceptions */
  OPT_fcode_hoisting = 1103,                 /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 1104,     /* -fcombine-stack-adjustments */
  OPT_fcommon = 1105,                        /* -fcommon */
  OPT_fcompare_debug = 1106,                 /* -fcompare-debug */
  OPT_fcompare_debug_second = 1107,          /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 1108,                /* -fcompare-debug= */
  OPT_fcompare_elim = 1109,                  /* -fcompare-elim */
  OPT_fconcepts = 1110,                      /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 1111,   /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 1112,                   /* -fconcepts-ts */
  OPT_fcond_mismatch = 1113,                 /* -fcond-mismatch */
  OPT_fcondition_coverage = 1114,            /* -fcondition-coverage */
  /* OPT_fconserve_space = 1115, */          /* -fconserve-space */
  OPT_fconserve_stack = 1116,                /* -fconserve-stack */
  OPT_fconstant_string_class_ = 1117,        /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 1118,        /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 1119,              /* -fconstexpr-depth= */
  OPT_fconstexpr_fp_except = 1120,           /* -fconstexpr-fp-except */
  OPT_fconstexpr_loop_limit_ = 1121,         /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 1122,          /* -fconstexpr-ops-limit= */
  OPT_fcontract_assumption_mode_ = 1123,     /* -fcontract-assumption-mode= */
  OPT_fcontract_build_level_ = 1124,         /* -fcontract-build-level= */
  OPT_fcontract_continuation_mode_ = 1125,   /* -fcontract-continuation-mode= */
  OPT_fcontract_mode_ = 1126,                /* -fcontract-mode= */
  OPT_fcontract_role_ = 1127,                /* -fcontract-role= */
  OPT_fcontract_semantic_ = 1128,            /* -fcontract-semantic= */
  OPT_fcontract_strict_declarations_ = 1129, /* -fcontract-strict-declarations= */
  OPT_fcontracts = 1130,                     /* -fcontracts */
  OPT_fconvert_ = 1131,                      /* -fconvert= */
  OPT_fcoroutines = 1132,                    /* -fcoroutines */
  OPT_fcpp = 1133,                           /* -fcpp */
  OPT_fcpp_begin = 1134,                     /* -fcpp-begin */
  OPT_fcpp_end = 1135,                       /* -fcpp-end */
  OPT_fcprop_registers = 1136,               /* -fcprop-registers */
  OPT_fcray_pointer = 1137,                  /* -fcray-pointer */
  OPT_fcrossjumping = 1138,                  /* -fcrossjumping */
  OPT_fcse_follow_jumps = 1139,              /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 1140, */         /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 1141,              /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 1142,              /* -fcx-limited-range */
  OPT_fd = 1143,                             /* -fd */
  OPT_fd_lines_as_code = 1144,               /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 1145,           /* -fd-lines-as-comments */
  OPT_fdata_sections = 1146,                 /* -fdata-sections */
  OPT_fdbg_cnt_list = 1147,                  /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 1148,                      /* -fdbg-cnt= */
  OPT_fdce = 1149,                           /* -fdce */
  OPT_fdebug = 1150,                         /* -fdebug */
  OPT_fdebug_aux_vars = 1151,                /* -fdebug-aux-vars */
  OPT_fdebug_builtins = 1152,                /* -fdebug-builtins */
  OPT_fdebug_cpp = 1153,                     /* -fdebug-cpp */
  OPT_fdebug_function_line_numbers = 1154,   /* -fdebug-function-line-numbers */
  OPT_fdebug_prefix_map_ = 1155,             /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 1156,           /* -fdebug-types-section */
  OPT_fdebug_ = 1157,                        /* -fdebug= */
  OPT_fdec = 1158,                           /* -fdec */
  OPT_fdec_blank_format_item = 1159,         /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 1160,          /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 1161,           /* -fdec-format-defaults */
  OPT_fdec_include = 1162,                   /* -fdec-include */
  OPT_fdec_intrinsic_ints = 1163,            /* -fdec-intrinsic-ints */
  OPT_fdec_math = 1164,                      /* -fdec-math */
  OPT_fdec_static = 1165,                    /* -fdec-static */
  OPT_fdec_structure = 1166,                 /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 1167,             /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 1168, */        /* -fdeduce-init-list */
  OPT_fdef_ = 1169,                          /* -fdef= */
  OPT_fdefault_double_8 = 1170,              /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 1171, */          /* -fdefault-inline */
  OPT_fdefault_integer_8 = 1172,             /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 1173,               /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 1174,               /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 1175,                /* -fdefault-real-8 */
  OPT_fdefaultbyte = 1176,                   /* -fdefaultbyte */
  OPT_fdefer_pop = 1177,                     /* -fdefer-pop */
  OPT_fdelayed_branch = 1178,                /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 1179,        /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 1180,    /* -fdelete-null-pointer-checks */
  OPT_fdeps_file_ = 1181,                    /* -fdeps-file= */
  OPT_fdeps_format_ = 1182,                  /* -fdeps-format= */
  OPT_fdeps_target_ = 1183,                  /* -fdeps-target= */
  OPT_fdevirtualize = 1184,                  /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 1185,        /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 1186,    /* -fdevirtualize-speculatively */
  OPT_fdiagnostics_add_output_ = 1187,       /* -fdiagnostics-add-output= */
  OPT_fdiagnostics_all_candidates = 1188,    /* -fdiagnostics-all-candidates */
  /* OPT_fdiagnostics_color = 1189, */       /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 1190,            /* -fdiagnostics-color= */
  OPT_fdiagnostics_column_origin_ = 1191,    /* -fdiagnostics-column-origin= */
  OPT_fdiagnostics_column_unit_ = 1192,      /* -fdiagnostics-column-unit= */
  OPT_fdiagnostics_escape_format_ = 1193,    /* -fdiagnostics-escape-format= */
  OPT_fdiagnostics_format_ = 1194,           /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 1195,    /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_json_formatting = 1196,   /* -fdiagnostics-json-formatting */
  OPT_fdiagnostics_minimum_margin_width_ = 1197,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 1198,  /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 1199,      /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_plain_output = 1200,      /* -fdiagnostics-plain-output */
  OPT_fdiagnostics_set_output_ = 1201,       /* -fdiagnostics-set-output= */
  OPT_fdiagnostics_show_caret = 1202,        /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 1203,          /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_event_links = 1204,  /* -fdiagnostics-show-event-links */
  OPT_fdiagnostics_show_highlight_colors = 1205,/* -fdiagnostics-show-highlight-colors */
  OPT_fdiagnostics_show_labels = 1206,       /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 1207, /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 1208,    /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 1209,       /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 1210,  /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_rules = 1211,        /* -fdiagnostics-show-rules */
  OPT_fdiagnostics_show_template_tree = 1212,/* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_text_art_charset_ = 1213, /* -fdiagnostics-text-art-charset= */
  OPT_fdiagnostics_urls_ = 1214,             /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 1215,               /* -fdirectives-only */
  OPT_fdisable_ = 1216,                      /* -fdisable- */
  OPT_fdoc = 1217,                           /* -fdoc */
  OPT_fdoc_dir_ = 1218,                      /* -fdoc-dir= */
  OPT_fdoc_file_ = 1219,                     /* -fdoc-file= */
  OPT_fdoc_inc_ = 1220,                      /* -fdoc-inc= */
  OPT_fdollar_ok = 1221,                     /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 1222,        /* -fdollars-in-identifiers */
  OPT_fdruntime = 1223,                      /* -fdruntime */
  OPT_fdse = 1224,                           /* -fdse */
  OPT_fdump_ = 1225,                         /* -fdump- */
  OPT_fdump_ada_spec = 1226,                 /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 1227,            /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 1228,                 /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 1229,       /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 1230,  /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 1231,  /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 1232,/* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 1233,/* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_exploded_paths = 1234,  /* -fdump-analyzer-exploded-paths */
  OPT_fdump_analyzer_feasibility = 1235,     /* -fdump-analyzer-feasibility */
  OPT_fdump_analyzer_infinite_loop = 1236,   /* -fdump-analyzer-infinite-loop */
  OPT_fdump_analyzer_json = 1237,            /* -fdump-analyzer-json */
  OPT_fdump_analyzer_state_purge = 1238,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1239,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1240,      /* -fdump-analyzer-supergraph */
  OPT_fdump_analyzer_untracked = 1241,       /* -fdump-analyzer-untracked */
  OPT_fdump_c___spec_verbose = 1242,         /* -fdump-c++-spec-verbose */
  OPT_fdump_c___spec_ = 1243,                /* -fdump-c++-spec= */
  /* OPT_fdump_core = 1244, */               /* -fdump-core */
  OPT_fdump_d_original = 1245,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1246,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1247,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1248,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1249,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1250,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1251,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1252,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1253,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1254, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1255,                   /* -fdump-passes */
  OPT_fdump_scos = 1256,                     /* -fdump-scos */
  OPT_fdump_system_exports = 1257,           /* -fdump-system-exports */
  OPT_fdump_unnumbered = 1258,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1259,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1260,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1261,                /* -fearly-inlining */
  OPT_felide_constructors = 1262,            /* -felide-constructors */
  OPT_felide_type = 1263,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1264, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1265,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1266,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1267,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1268,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1269,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1270,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1271,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1272,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1273,                /* -fenum-int-equiv */
  OPT_fexceptions = 1274,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1275,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1276,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1277,       /* -fexpensive-optimizations */
  OPT_fext_dce = 1278,                       /* -fext-dce */
  OPT_fext_numeric_literals = 1279,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1280,          /* -fextended-identifiers */
  OPT_fextended_opaque = 1281,               /* -fextended-opaque */
  OPT_fextern_std_ = 1282,                   /* -fextern-std= */
  OPT_fextern_tls_init = 1283,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1284,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1285,            /* -fexternal-templates */
  OPT_ff2c = 1286,                           /* -ff2c */
  OPT_ffast_math = 1287,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1288,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1289,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1290,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1291,              /* -ffinite-math-only */
  OPT_ffixed_ = 1292,                        /* -ffixed- */
  OPT_ffixed_form = 1293,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1294,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1295,        /* -ffixed-line-length-none */
  OPT_fflex_debug = 1296,                    /* -fflex-debug */
  ...
  OPT_findicator_column = 1374,              /* -findicator-column */
  OPT_findirect_inlining = 1375,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1376,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1377,               /* -finit-character= */
  OPT_finit_derived = 1378,                  /* -finit-derived */
  OPT_finit_integer_ = 1379,                 /* -finit-integer= */
  OPT_finit_local_zero = 1380,               /* -finit-local-zero */
  OPT_finit_logical_ = 1381,                 /* -finit-logical= */
  OPT_finit_real_ = 1382,                    /* -finit-real= */
  OPT_finline = 1383,                        /* -finline */
  OPT_finline_arg_packing = 1384,            /* -finline-arg-packing */
  OPT_finline_atomics = 1385,                /* -finline-atomics */
  OPT_finline_functions = 1386,              /* -finline-functions */
  OPT_finline_functions_called_once = 1387,  /* -finline-functions-called-once */
  OPT_finline_intrinsics = 1388,             /* -finline-intrinsics */
  OPT_finline_intrinsics_ = 1389,            /* -finline-intrinsics= */
  /* OPT_finline_limit_ = 1390, */           /* -finline-limit- */
  OPT_finline_limit_ = 1391,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1392,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1393,        /* -finline-small-functions */
  OPT_finline_stringops = 1394,              /* -finline-stringops */
  OPT_finline_stringops_ = 1395,             /* -finline-stringops= */
  OPT_finput_charset_ = 1396,                /* -finput-charset= */
  OPT_finstrument_functions = 1397,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1398,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1399,/* -finstrument-functions-exclude-function-list= */
  OPT_finstrument_functions_once = 1400,     /* -finstrument-functions-once */
  OPT_finteger_4_integer_8 = 1401,           /* -finteger-4-integer-8 */
  OPT_finternal_ebcdic = 1402,               /* -finternal-ebcdic */
  OPT_fintrinsic_modules_path = 1403,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1404,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1405,                    /* -finvariants */
  OPT_fipa_bit_cp = 1406,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1407,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1408, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1409,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1410,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1411,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1412,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1413, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1414,                    /* -fipa-modref */
  OPT_fipa_profile = 1415,                   /* -fipa-profile */
  OPT_fipa_pta = 1416,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1417,                /* -fipa-pure-const */
  OPT_fipa_ra = 1418,                        /* -fipa-ra */
  OPT_fipa_reference = 1419,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1420,     /* -fipa-reference-addressable */
  OPT_fipa_sra = 1421,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1422,           /* -fipa-stack-alignment */
  OPT_fipa_strict_aliasing = 1423,           /* -fipa-strict-aliasing */
  /* OPT_fipa_struct_reorg = 1424, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1425,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1426,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1427,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1428,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1429,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1430,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1431,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1432,                  /* -fira-verbose= */
  OPT_fiso = 1433,                           /* -fiso */
  OPT_fisolate_erroneous_paths_attribute = 1434,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1435,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1436,              /* -fivar-visibility= */
  OPT_fivopts = 1437,                        /* -fivopts */
  OPT_fjump_tables = 1438,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1439,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1440,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1441,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1442,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1443,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1444,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1445,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1446,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1447,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1448,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1449,         /* -flang-info-module-cmi= */
  /* OPT_flarge_source_files = 1450, */      /* -flarge-source-files */
  OPT_flate_combine_instructions = 1451,     /* -flate-combine-instructions */
  OPT_flax_vector_conversions = 1452,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1453,            /* -fleading-underscore */
  OPT_flibs_ = 1454,                         /* -flibs= */
  OPT_flifetime_dse = 1455,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1456,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1457,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1458,                /* -flinker-output= */
  /* OPT_flive_patching = 1459, */           /* -flive-patching */
  OPT_flive_patching_ = 1460,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1461,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1462,                   /* -flocal-ivars */
  OPT_flocation_ = 1463,                     /* -flocation= */
  /* OPT_floop_block = 1464, */              /* -floop-block */
  /* OPT_floop_flatten = 1465, */            /* -floop-flatten */
  OPT_floop_interchange = 1466,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1467,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1468, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1469,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1470, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1471,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1472,                     /* -flra-remat */
  OPT_flto = 1473,                           /* -flto */
  OPT_flto_compression_level_ = 1474,        /* -flto-compression-level= */
  OPT_flto_incremental_cache_size_ = 1475,   /* -flto-incremental-cache-size= */
  OPT_flto_incremental_ = 1476,              /* -flto-incremental= */
  /* OPT_flto_odr_type_merging = 1477, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1478,                /* -flto-partition= */
  OPT_flto_report = 1479,                    /* -flto-report */
  OPT_flto_report_wpa = 1480,                /* -flto-report-wpa */
  OPT_flto_ = 1481,                          /* -flto= */
  OPT_fltrans = 1482,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1483,           /* -fltrans-output-list= */
  OPT_fm2_debug_trace_ = 1484,               /* -fm2-debug-trace= */
  OPT_fm2_dump_decl_ = 1485,                 /* -fm2-dump-decl= */
  OPT_fm2_dump_filter_ = 1486,               /* -fm2-dump-filter= */
  OPT_fm2_dump_gimple_ = 1487,               /* -fm2-dump-gimple= */
  OPT_fm2_dump_quad_ = 1488,                 /* -fm2-dump-quad= */
  OPT_fm2_dump_ = 1489,                      /* -fm2-dump= */
  OPT_fm2_file_offset_bits_ = 1490,          /* -fm2-file-offset-bits= */
  OPT_fm2_g = 1491,                          /* -fm2-g */
  OPT_fm2_lower_case = 1492,                 /* -fm2-lower-case */
  OPT_fm2_pathname_ = 1493,                  /* -fm2-pathname= */
  OPT_fm2_pathnameI = 1494,                  /* -fm2-pathnameI */
  OPT_fm2_plugin = 1495,                     /* -fm2-plugin */
  OPT_fm2_prefix_ = 1496,                    /* -fm2-prefix= */
  OPT_fm2_statistics = 1497,                 /* -fm2-statistics */
  OPT_fm2_strict_type = 1498,                /* -fm2-strict-type */
  OPT_fm2_whole_program = 1499,              /* -fm2-whole-program */
  OPT_fmacro_prefix_map_ = 1500,             /* -fmacro-prefix-map= */
  OPT_fmain = 1501,                          /* -fmain */
  OPT_fmalloc_dce = 1502,                    /* -fmalloc-dce */
  OPT_fmalloc_dce_ = 1503,                   /* -fmalloc-dce= */
  OPT_fmath_errno = 1504,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1505,        /* -fmax-array-constructor= */
  OPT_fmax_errors = 1506,                    /* -fmax-errors */
  OPT_fmax_errors_ = 1507,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1508,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1509,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1510,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1511,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1512,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1513,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1514,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1515,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1516,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1517,               /* -fmessage-length= */
  OPT_fmin_function_alignment_ = 1518,       /* -fmin-function-alignment= */
  OPT_fmod_ = 1519,                          /* -fmod= */
  OPT_fmodule_file_ = 1520,                  /* -fmodule-file= */
  OPT_fmodule_header = 1521,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1522,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1523,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1524,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1525,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1526,                   /* -fmodule-only */
  OPT_fmodule_private = 1527,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1528,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1529,                    /* -fmoduleinfo */
  OPT_fmodules = 1530,                       /* -fmodules */
  /* OPT_fmodules_ts = 1531, */              /* -fmodules-ts */
  OPT_fmodulo_sched = 1532,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1533,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1534,          /* -fmove-loop-invariants */
  OPT_fmove_loop_stores = 1535,              /* -fmove-loop-stores */
  OPT_fms_extensions = 1536,                 /* -fms-extensions */
  OPT_fmudflap = 1537,                       /* -fmudflap */
  OPT_fmudflapir = 1538,                     /* -fmudflapir */
  OPT_fmudflapth = 1539,                     /* -fmudflapth */
  OPT_fmultiflags = 1540,                    /* -fmultiflags */
  OPT_fname_mangling_version_ = 1541,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1542,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1543,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1544,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1545,                  /* -fnext-runtime */
  OPT_fnil = 1546,                           /* -fnil */
  OPT_fnil_receivers = 1547,                 /* -fnil-receivers */
  OPT_fno_inline_intrinsics = 1548,          /* -fno-inline-intrinsics */
  OPT_fno_inline_stringops = 1549,           /* -fno-inline-stringops */
  OPT_fnon_call_exceptions = 1550,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1551,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1552,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1553,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1554,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1555,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1556,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1557,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1558,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1559,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1560,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1561,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_host_opts_ = 1562,        /* -foffload-abi-host-opts= */
  OPT_foffload_abi_ = 1563,                  /* -foffload-abi= */
  OPT_foffload_options_ = 1564,              /* -foffload-options= */
  OPT_foffload_ = 1565,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1566,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1567,                         /* -fonly= */
  OPT_fopenacc = 1568,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1569,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1570,                        /* -fopenmp */
  OPT_fopenmp_allocators = 1571,             /* -fopenmp-allocators */
  OPT_fopenmp_simd = 1572,                   /* -fopenmp-simd */
  /* OPT_fopenmp_target_simd_clone = 1573, *//* -fopenmp-target-simd-clone */
  OPT_fopenmp_target_simd_clone_ = 1574,     /* -fopenmp-target-simd-clone= */
  OPT_foperator_names = 1575,                /* -foperator-names */
  OPT_fopt_info = 1576,                      /* -fopt-info */
  OPT_fopt_info_ = 1577,                     /* -fopt-info- */
  OPT_foptimize_crc = 1578,                  /* -foptimize-crc */
  /* OPT_foptimize_register_move = 1579, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1580,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1581,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1582, */          /* -foptional-diags */
  OPT_fpack_derived = 1583,                  /* -fpack-derived */
  OPT_fpack_struct = 1584,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1585,                  /* -fpack-struct= */
  OPT_fpad_source = 1586,                    /* -fpad-source */
  OPT_fpartial_inlining = 1587,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1588,     /* -fpatchable-function-entry= */
  OPT_fpath_coverage = 1589,                 /* -fpath-coverage */
  OPT_fpath_coverage_limit_ = 1590,          /* -fpath-coverage-limit= */
  OPT_fpcc_struct_return = 1591,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1592,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1593,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1594,                    /* -fpeel-loops */
  OPT_fpeephole = 1595,                      /* -fpeephole */
  OPT_fpeephole2 = 1596,                     /* -fpeephole2 */
  OPT_fpermissive = 1597,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1598,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1599,                           /* -fpic */
  OPT_fpie = 1600,                           /* -fpie */
  OPT_fpim = 1601,                           /* -fpim */
  OPT_fpim2 = 1602,                          /* -fpim2 */
  OPT_fpim3 = 1603,                          /* -fpim3 */
  OPT_fpim4 = 1604,                          /* -fpim4 */
  OPT_fplan9_extensions = 1605,              /* -fplan9-extensions */
  OPT_fplt = 1606,                           /* -fplt */
  OPT_fplugin_arg_ = 1607,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1608,                       /* -fplugin= */
  OPT_fpositive_mod_floor_div = 1609,        /* -fpositive-mod-floor-div */
  OPT_fpost_ipa_mem_report = 1610,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1611,                /* -fpostconditions */
  OPT_fpre_include_ = 1612,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1613,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1614,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1615,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1616,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1617,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1618,              /* -fpretty-templates */
  OPT_fpreview_all = 1619,                   /* -fpreview=all */
  OPT_fpreview_bitfields = 1620,             /* -fpreview=bitfields */
  OPT_fpreview_dip1000 = 1621,               /* -fpreview=dip1000 */
  OPT_fpreview_dip1008 = 1622,               /* -fpreview=dip1008 */
  OPT_fpreview_dip1021 = 1623,               /* -fpreview=dip1021 */
  OPT_fpreview_dtorfields = 1624,            /* -fpreview=dtorfields */
  OPT_fpreview_fieldwise = 1625,             /* -fpreview=fieldwise */
  OPT_fpreview_fixaliasthis = 1626,          /* -fpreview=fixaliasthis */
  OPT_fpreview_fiximmutableconv = 1627,      /* -fpreview=fiximmutableconv */
  OPT_fpreview_in = 1628,                    /* -fpreview=in */
  OPT_fpreview_inclusiveincontracts = 1629,  /* -fpreview=inclusiveincontracts */
  OPT_fpreview_nosharedaccess = 1630,        /* -fpreview=nosharedaccess */
  OPT_fpreview_rvaluerefparam = 1631,        /* -fpreview=rvaluerefparam */
  OPT_fpreview_safer = 1632,                 /* -fpreview=safer */
  OPT_fpreview_systemvariables = 1633,       /* -fpreview=systemvariables */
  OPT_fprintf_return_value = 1634,           /* -fprintf-return-value */
  OPT_fprofile = 1635,                       /* -fprofile */
  OPT_fprofile_abs_path = 1636,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1637,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1638,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1639,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1640,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1641,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1642,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1643,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1644,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1645,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1646,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1647,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_map_ = 1648,           /* -fprofile-prefix-map= */
  OPT_fprofile_prefix_path_ = 1649,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1650,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1651,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1652,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1653,               /* -fprofile-update= */
  OPT_fprofile_use = 1654,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1655,                  /* -fprofile-use= */
  OPT_fprofile_values = 1656,                /* -fprofile-values */
  OPT_fprotect_parens = 1657,                /* -fprotect-parens */
  OPT_fpthread = 1658,                       /* -fpthread */
  OPT_fq = 1659,                             /* -fq */
  OPT_frandom_seed = 1660,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1661,                  /* -frandom-seed= */
  OPT_frange = 1662,                         /* -frange */
  OPT_frange_check = 1663,                   /* -frange-check */
  OPT_frange_for_ext_temps = 1664,           /* -frange-for-ext-temps */
  OPT_freal_4_real_10 = 1665,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1666,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1667,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1668,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1669,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1670,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1671,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1672,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1673,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1674,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1675,               /* -frecord-marker=8 */
  OPT_frecursive = 1676,                     /* -frecursive */
  OPT_free = 1677,                           /* -free */
  /* OPT_freg_struct_return = 1678, */       /* -freg-struct-return */
  /* OPT_fregmove = 1679, */                 /* -fregmove */
  OPT_frelease = 1680,                       /* -frelease */
  OPT_frename_registers = 1681,              /* -frename-registers */
  OPT_freorder_blocks = 1682,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1683,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1684,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1685,             /* -freorder-functions */
  OPT_frepack_arrays = 1686,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1687,          /* -freplace-objc-classes */
  OPT_frepo = 1688,                          /* -frepo */
  OPT_freport_bug = 1689,                    /* -freport-bug */
  OPT_frequire_return_statement = 1690,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1691,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1692, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1693,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1694,                   /* -fresolution= */
  OPT_freturn = 1695,                        /* -freturn */
  OPT_frevert_all = 1696,                    /* -frevert=all */
  OPT_frevert_dip1000 = 1697,                /* -frevert=dip1000 */
  OPT_frevert_dtorfields = 1698,             /* -frevert=dtorfields */
  OPT_frevert_intpromote = 1699,             /* -frevert=intpromote */
  OPT_frounding_math = 1700,                 /* -frounding-math */
  OPT_frtti = 1701,                          /* -frtti */
  OPT_fruntime_modules_ = 1702,              /* -fruntime-modules= */
  OPT_frust_borrowcheck = 1703,              /* -frust-borrowcheck */
  OPT_frust_cfg_ = 1704,                     /* -frust-cfg= */
  OPT_frust_compile_until_ = 1705,           /* -frust-compile-until= */
  OPT_frust_crate_type_ = 1706,              /* -frust-crate-type= */
  OPT_frust_crate_ = 1707,                   /* -frust-crate= */
  OPT_frust_debug = 1708,                    /* -frust-debug */
  OPT_frust_dump_ = 1709,                    /* -frust-dump- */
  OPT_frust_edition_ = 1710,                 /* -frust-edition= */
  OPT_frust_embed_metadata = 1711,           /* -frust-embed-metadata */
  OPT_frust_extern_ = 1712,                  /* -frust-extern= */
  OPT_frust_incomplete_and_experimental_compiler_do_not_use = 1713,/* -frust-incomplete-and-experimental-compiler-do-not-use */
  OPT_frust_mangling_ = 1714,                /* -frust-mangling= */
  OPT_frust_max_recursion_depth_ = 1715,     /* -frust-max-recursion-depth= */
  OPT_frust_metadata_output_ = 1716,         /* -frust-metadata-output= */
  OPT_frust_name_resolution_2_0 = 1717,      /* -frust-name-resolution-2.0 */
  OPT_frust_overflow_checks = 1718,          /* -frust-overflow-checks */
  OPT_frust_panic_ = 1719,                   /* -frust-panic= */
  OPT_fsanitize_address_use_after_scope = 1720,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1721,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1722,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1723,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1724,            /* -fsanitize-sections= */
  OPT_fsanitize_trap = 1725,                 /* -fsanitize-trap */
  OPT_fsanitize_trap_ = 1726,                /* -fsanitize-trap= */
  /* OPT_fsanitize_undefined_trap_on_error = 1727, *//* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1728,                     /* -fsanitize= */
  OPT_fsave_mixins_ = 1729,                  /* -fsave-mixins= */
  OPT_fsave_optimization_record = 1730,      /* -fsave-optimization-record */
  OPT_fscaffold_c = 1731,                    /* -fscaffold-c */
  OPT_fscaffold_c__ = 1732,                  /* -fscaffold-c++ */
  OPT_fscaffold_dynamic = 1733,              /* -fscaffold-dynamic */
  OPT_fscaffold_main = 1734,                 /* -fscaffold-main */
  OPT_fscaffold_static = 1735,               /* -fscaffold-static */
  OPT_fsched_critical_path_heuristic = 1736, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1737,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1738,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1739,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1740,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1741,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1742,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1743,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1744,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1745,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1746,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1747,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1748,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1749,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1750,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1751,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1752,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1753, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1754,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1755,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1756,               /* -fschedule-insns2 */
  OPT_fsearch_include_path = 1757,           /* -fsearch-include-path */
  OPT_fsearch_include_path_ = 1758,          /* -fsearch-include-path= */
  OPT_fsecond_underscore = 1759,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1760,               /* -fsection-anchors */
  /* OPT_fsee = 1761, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1762,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1763,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1764,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1765,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1766,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1767,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1768,        /* -fsemantic-interposition */
  OPT_fshared = 1769,                        /* -fshared */
  OPT_fshort_enums = 1770,                   /* -fshort-enums */
  OPT_fshort_wchar = 1771,                   /* -fshort-wchar */
  OPT_fshow_column = 1772,                   /* -fshow-column */
  OPT_fshrink_wrap = 1773,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1774,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1775,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1776,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1777,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1778,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1779,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1780,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1781,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1782,            /* -fsized-deallocation */
  OPT_fsoft_check_all = 1783,                /* -fsoft-check-all */
  OPT_fsources = 1784,                       /* -fsources */
  OPT_fsplit_ivs_in_unroller = 1785,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1786,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1787,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1788,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1789,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1790,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1791,                      /* -fsquangle */
  OPT_fssa_backprop = 1792,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1793,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1794,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1795,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1796, */             /* -fstack-check */
  OPT_fstack_check_ = 1797,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1798,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1799,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1800,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1801,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1802,               /* -fstack-protector */
  OPT_fstack_protector_all = 1803,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1804,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1805,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1806,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1807,                   /* -fstack-usage */
  OPT_fstatic_call = 1808,                   /* -fstatic-call */
  OPT_fstats = 1809,                         /* -fstats */
  OPT_fstdarg_opt = 1810,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1811,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1812, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1813,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1814,                  /* -fstrict-enums */
  /* OPT_fstrict_flex_arrays = 1815, */      /* -fstrict-flex-arrays */
  OPT_fstrict_flex_arrays_ = 1816,           /* -fstrict-flex-arrays= */
  OPT_fstrict_overflow = 1817,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1818,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1819,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1820, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1821,            /* -fstrong-eval-order= */
  OPT_fstrub_all = 1822,                     /* -fstrub=all */
  OPT_fstrub_at_calls = 1823,                /* -fstrub=at-calls */
  OPT_fstrub_disable = 1824,                 /* -fstrub=disable */
  OPT_fstrub_internal = 1825,                /* -fstrub=internal */
  OPT_fstrub_relaxed = 1826,                 /* -fstrub=relaxed */
  OPT_fstrub_strict = 1827,                  /* -fstrub=strict */
  OPT_fswig = 1828,                          /* -fswig */
  OPT_fswitch_errors = 1829,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1830,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1831,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1832,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1833, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1834,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1835, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1836,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1837, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1838,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1839,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1840,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1841,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1842,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1843,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1844,                   /* -ftime-report */
  OPT_ftime_report_details = 1845,           /* -ftime-report-details */
  OPT_ftls_model_ = 1846,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1847,              /* -ftoplevel-reorder */
  OPT_ftrace_debug = 1848,                   /* -ftrace-debug */
  OPT_ftracer = 1849,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1850,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1851,        /* -ftrack-macro-expansion= */
  OPT_ftrampoline_impl_ = 1852,              /* -ftrampoline-impl= */
  OPT_ftrampolines = 1853,                   /* -ftrampolines */
  OPT_ftransition_all = 1854,                /* -ftransition=all */
  OPT_ftransition_field = 1855,              /* -ftransition=field */
  OPT_ftransition_in = 1856,                 /* -ftransition=in */
  OPT_ftransition_nogc = 1857,               /* -ftransition=nogc */
  OPT_ftransition_templates = 1858,          /* -ftransition=templates */
  OPT_ftransition_tls = 1859,                /* -ftransition=tls */
  OPT_ftrapping_math = 1860,                 /* -ftrapping-math */
  OPT_ftrapv = 1861,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1862,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1863,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1864,                      /* -ftree-ccp */
  OPT_ftree_ch = 1865,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1866, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1867,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1868,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1869, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1870,                   /* -ftree-cselim */
  OPT_ftree_dce = 1871,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1872,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1873,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1874,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1875,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1876, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1877,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1878,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1879, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1880,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1881,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1882, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1883,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1884,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1885,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1886,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1887,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1888,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1889,                      /* -ftree-pre */
  OPT_ftree_pta = 1890,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1891,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1892, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1893,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1894,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1895,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1896,                     /* -ftree-slsr */
  OPT_ftree_sra = 1897,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1898, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1899, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1900,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1901,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1902,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1903, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1904,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1905, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1906,                      /* -ftree-vrp */
  OPT_ftrivial_auto_var_init_ = 1907,        /* -ftrivial-auto-var-init= */
  OPT_funbounded_by_reference = 1908,        /* -funbounded-by-reference */
  OPT_funconstrained_commons = 1909,         /* -funconstrained-commons */
  OPT_funderscoring = 1910,                  /* -funderscoring */
  OPT_funit_at_a_time = 1911,                /* -funit-at-a-time */
  OPT_funittest = 1912,                      /* -funittest */
  OPT_funreachable_traps = 1913,             /* -funreachable-traps */
  OPT_funroll_all_loops = 1914,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1915,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1916,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1917, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1918,     /* -funsafe-math-optimizations */
  OPT_funsigned = 1919,                      /* -funsigned */
  OPT_funsigned_bitfields = 1920,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1921,                 /* -funsigned-char */
  OPT_funswitch_loops = 1922,                /* -funswitch-loops */
  OPT_funwind_tables = 1923,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1924,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1925,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1926,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1927,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1928,                    /* -fuse-ld=lld */
  OPT_fuse_ld_mold = 1929,                   /* -fuse-ld=mold */
  OPT_fuse_linker_plugin = 1930,             /* -fuse-linker-plugin */
  OPT_fuse_list_ = 1931,                     /* -fuse-list= */
  OPT_fvar_tracking = 1932,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1933,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1934,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1935,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1936,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1937, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1938,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1939,                   /* -fverbose-asm */
  /* OPT_fversion = 1940, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1941,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1942,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1943,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1944,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1945,                   /* -fvisibility= */
  OPT_fvpt = 1946,                           /* -fvpt */
  OPT_fvtable_gc = 1947,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1948,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1949,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1950,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1951,                     /* -fvtv-debug */
  OPT_fweak = 1952,                          /* -fweak */
  OPT_fweak_templates = 1953,                /* -fweak-templates */
  OPT_fweb = 1954,                           /* -fweb */
  /* OPT_fwhole_file = 1955, */              /* -fwhole-file */
  OPT_fwhole_program = 1956,                 /* -fwhole-program */
  OPT_fwholediv = 1957,                      /* -fwholediv */
  OPT_fwholevalue = 1958,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 1959,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1960,             /* -fworking-directory */
  OPT_fwpa = 1961,                           /* -fwpa */
  OPT_fwpa_ = 1962,                          /* -fwpa= */
  OPT_fwrapv = 1963,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1964,                 /* -fwrapv-pointer */
  OPT_fxref = 1965,                          /* -fxref */
  OPT_fyacc_debug = 1966,                    /* -fyacc-debug */
  /* OPT_fzee = 1967, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 1968,          /* -fzero-call-used-regs= */
  OPT_fzero_init_padding_bits_ = 1969,       /* -fzero-init-padding-bits= */
  OPT_fzero_initialized_in_bss = 1970,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1971,                     /* -fzero-link */
  OPT_g = 1972,                              /* -g */
  OPT_gant = 1973,                           /* -gant */
  OPT_gas_loc_support = 1974,                /* -gas-loc-support */
  OPT_gas_locview_support = 1975,            /* -gas-locview-support */
  OPT_gbtf = 1976,                           /* -gbtf */
  OPT_gcodeview = 1977,                      /* -gcodeview */
  OPT_gcoff = 1978,                          /* -gcoff */
  OPT_gcoff1 = 1979,                         /* -gcoff1 */
  OPT_gcoff2 = 1980,                         /* -gcoff2 */
  OPT_gcoff3 = 1981,                         /* -gcoff3 */
  OPT_gcolumn_info = 1982,                   /* -gcolumn-info */
  OPT_gctf = 1983,                           /* -gctf */
  OPT_gdescribe_dies = 1984,                 /* -gdescribe-dies */
  OPT_gdwarf = 1985,                         /* -gdwarf */
  OPT_gdwarf_ = 1986,                        /* -gdwarf- */
  OPT_gdwarf32 = 1987,                       /* -gdwarf32 */
  OPT_gdwarf64 = 1988,                       /* -gdwarf64 */
  OPT_gen_decls = 1989,                      /* -gen-decls */
  OPT_ggdb = 1990,                           /* -ggdb */
  OPT_ggnu_pubnames = 1991,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1992,                   /* -gimple-stats */
  OPT_ginline_points = 1993,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1994, /* -ginternal-reset-location-views */
  OPT_gnat = 1995,                           /* -gnat */
  OPT_gnatO = 1996,                          /* -gnatO */
  OPT_gno_ = 1997,                           /* -gno- */
  OPT_gno_pubnames = 1998,                   /* -gno-pubnames */
  OPT_gprune_btf = 1999,                     /* -gprune-btf */
  OPT_gpubnames = 2000,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 2001,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 2002,                   /* -gsplit-dwarf */
  OPT_gstabs = 2003,                         /* -gstabs */
  OPT_gstabs_ = 2004,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 2005,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 2006,                  /* -gstrict-dwarf */
  OPT_gtoggle = 2007,                        /* -gtoggle */
  OPT_gvariable_location_views = 2008,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 2009,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 2010,                           /* -gvms */
  OPT_gxcoff = 2011,                         /* -gxcoff */
  OPT_gxcoff_ = 2012,                        /* -gxcoff+ */
  OPT_gz = 2013,                             /* -gz */
  OPT_gz_ = 2014,                            /* -gz= */
  OPT_h = 2015,                              /* -h */
  OPT_help = 2016,                           /* -help */
  OPT_idirafter = 2017,                      /* -idirafter */
  OPT_imacros = 2018,                        /* -imacros */
  OPT_imultiarch = 2019,                     /* -imultiarch */
  OPT_imultilib = 2020,                      /* -imultilib */
  OPT_include = 2021,                        /* -include */
  OPT_iplugindir_ = 2022,                    /* -iplugindir= */
  OPT_iprefix = 2023,                        /* -iprefix */
  OPT_iquote = 2024,                         /* -iquote */
  OPT_isysroot = 2025,                       /* -isysroot */
  OPT_isystem = 2026,                        /* -isystem */
  OPT_iwithprefix = 2027,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 2028,              /* -iwithprefixbefore */
  OPT_k8 = 2029,                             /* -k8 */
  OPT_l = 2030,                              /* -l */
  OPT_lang_asm = 2031,                       /* -lang-asm */
  OPT_list = 2032,                           /* -list */
  OPT_mabi_ = 2033,                          /* -mabi= */
  OPT_mabort_on_noreturn = 2034,             /* -mabort-on-noreturn */
  OPT_main = 2035,                           /* -main */
  OPT_main_ = 2036,                          /* -main= */
  OPT_mandroid = 2037,                       /* -mandroid */
  OPT_mapcs = 2038,                          /* -mapcs */
  OPT_mapcs_frame = 2039,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 2040,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 2041,              /* -mapcs-stack-check */
  OPT_march_ = 2042,                         /* -march= */
  OPT_marm = 2043,                           /* -marm */
  OPT_masm_syntax_unified = 2044,            /* -masm-syntax-unified */
  OPT_mbe32 = 2045,                          /* -mbe32 */
  OPT_mbe8 = 2046,                           /* -mbe8 */
  OPT_mbig_endian = 2047,                    /* -mbig-endian */
  OPT_mbionic = 2048,                        /* -mbionic */
  OPT_mbranch_cost_ = 2049,                  /* -mbranch-cost= */
  OPT_mbranch_protection_ = 2050,            /* -mbranch-protection= */
  OPT_mcallee_super_interworking = 2051,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 2052,     /* -mcaller-super-interworking */
  OPT_mcmse = 2053,                          /* -mcmse */
  OPT_mcpu_ = 2054,                          /* -mcpu= */
  OPT_mdlstp = 2055,                         /* -mdlstp */
  OPT_mfdpic = 2056,                         /* -mfdpic */
  OPT_mfix_cmse_cve_2021_35465 = 2057,       /* -mfix-cmse-cve-2021-35465 */
  OPT_mfix_cortex_a57_aes_1742098 = 2058,    /* -mfix-cortex-a57-aes-1742098 */
  /* OPT_mfix_cortex_a72_aes_1655431 = 2059, *//* -mfix-cortex-a72-aes-1655431 */
  OPT_mfix_cortex_m3_ldrd = 2060,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 2061,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 2062,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 2063,                  /* -mfp16-format= */
  OPT_mfpu_ = 2064,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 2065,             /* -mgeneral-regs-only */
  OPT_mglibc = 2066,                         /* -mglibc */
  /* OPT_mhard_float = 2067, */              /* -mhard-float */
  OPT_mlibarch_ = 2068,                      /* -mlibarch= */
  OPT_mlittle_endian = 2069,                 /* -mlittle-endian */
  OPT_mlong_calls = 2070,                    /* -mlong-calls */
  OPT_mmusl = 2071,                          /* -mmusl */
  OPT_mneon_for_64bits = 2072,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 2073,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 2074,                 /* -mpic-register= */
  OPT_mpoke_function_name = 2075,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 2076,               /* -mprint-tune-info */
  OPT_mpure_code = 2077,                     /* -mpure-code */
  OPT_mrestrict_it = 2078,                   /* -mrestrict-it */
  OPT_msched_prolog = 2079,                  /* -msched-prolog */
  OPT_msingle_pic_base = 2080,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 2081,               /* -mslow-flash-data */
  /* OPT_msoft_float = 2082, */              /* -msoft-float */
  OPT_mstack_protector_guard_offset_ = 2083, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_ = 2084,        /* -mstack-protector-guard= */
  OPT_mstructure_size_boundary_ = 2085,      /* -mstructure-size-boundary= */
  OPT_mthumb = 2086,                         /* -mthumb */
  OPT_mthumb_interwork = 2087,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 2088,                  /* -mtls-dialect= */
  OPT_mtp_ = 2089,                           /* -mtp= */
  OPT_mtpcs_frame = 2090,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 2091,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 2092,                         /* -mtune= */
  OPT_muclibc = 2093,                        /* -muclibc */
  ...
  OPT_profile = 2137,                        /* -profile */
  OPT_pthread = 2138,                        /* -pthread */
  OPT_quiet = 2139,                          /* -quiet */
  OPT_r = 2140,                              /* -r */
  OPT_rdynamic = 2141,                       /* -rdynamic */
  OPT_remap = 2142,                          /* -remap */
  OPT_reverse_sort = 2143,                   /* -reverse-sort */
  OPT_s = 2144,                              /* -s */
  OPT_save_temps = 2145,                     /* -save-temps */
  OPT_save_temps_ = 2146,                    /* -save-temps= */
  OPT_shared = 2147,                         /* -shared */
  OPT_shared_libgcc = 2148,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2149,               /* -shared-libphobos */
  OPT_size_sort = 2150,                      /* -size-sort */
  /* OPT_specs = 2151, */                    /* -specs */
  OPT_specs_ = 2152,                         /* -specs= */
  OPT_static = 2153,                         /* -static */
  OPT_static_libasan = 2154,                 /* -static-libasan */
  OPT_static_libgcc = 2155,                  /* -static-libgcc */
  OPT_static_libgcobol = 2156,               /* -static-libgcobol */
  OPT_static_libgfortran = 2157,             /* -static-libgfortran */
  OPT_static_libgm2 = 2158,                  /* -static-libgm2 */
  OPT_static_libgo = 2159,                   /* -static-libgo */
  OPT_static_libhwasan = 2160,               /* -static-libhwasan */
  OPT_static_liblsan = 2161,                 /* -static-liblsan */
  OPT_static_libmpx = 2162,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2163,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2164,               /* -static-libphobos */
  OPT_static_libquadmath = 2165,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2166,               /* -static-libstdc++ */
  OPT_static_libtsan = 2167,                 /* -static-libtsan */
  OPT_static_libubsan = 2168,                /* -static-libubsan */
  OPT_static_pie = 2169,                     /* -static-pie */
  /* OPT_std_c__03 = 2170, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2171, */                /* -std=c++0x */
  OPT_std_c__11 = 2172,                      /* -std=c++11 */
  OPT_std_c__14 = 2173,                      /* -std=c++14 */
  OPT_std_c__17 = 2174,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2175, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2176, */                /* -std=c++1z */
  OPT_std_c__20 = 2177,                      /* -std=c++20 */
  OPT_std_c__23 = 2178,                      /* -std=c++23 */
  OPT_std_c__26 = 2179,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2180, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2181, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2182, */                /* -std=c++2c */
  ...
  OPT_std_c23 = 2188,                        /* -std=c23 */
  /* OPT_std_c2x = 2189, */                  /* -std=c2x */
  OPT_std_c2y = 2190,                        /* -std=c2y */
  ...
  OPT_std_f2023 = 2199,                      /* -std=f2023 */
  OPT_std_f202y = 2200,                      /* -std=f202y */
  OPT_std_f95 = 2201,                        /* -std=f95 */
  OPT_std_gnu = 2202,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2203, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2204, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2205,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2206,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2207,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2208, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2209, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2210,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2211,                    /* -std=gnu++23 */
  OPT_std_gnu__26 = 2212,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2213, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2214, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2215, */              /* -std=gnu++2c */
  ...
  OPT_std_gnu23 = 2221,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2222, */                /* -std=gnu2x */
  OPT_std_gnu2y = 2223,                      /* -std=gnu2y */
  ...
  /* OPT_std_iso9899_2024 = 2235, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2236,                     /* -std=legacy */
  OPT_stdlib_ = 2237,                        /* -stdlib= */
  OPT_symbol_ = 2238,                        /* -symbol= */
  OPT_symbolic = 2239,                       /* -symbolic */
  OPT_t = 2240,                              /* -t */
  OPT_time = 2241,                           /* -time */
  OPT_time_ = 2242,                          /* -time= */
  OPT_tno_android_cc = 2243,                 /* -tno-android-cc */
  OPT_tno_android_ld = 2244,                 /* -tno-android-ld */
  ...
  OPT_truncate = 2249,                       /* -truncate */
  OPT_type_stats = 2250,                     /* -type-stats */
  OPT_u = 2251,                              /* -u */
  OPT_undef = 2252,                          /* -undef */
  OPT_v = 2253,                              /* -v */
  OPT_version = 2254,                        /* -version */
  OPT_w = 2255,                              /* -w */
  OPT_wrapper = 2256,                        /* -wrapper */
  OPT_x = 2257,                              /* -x */
  OPT_z = 2258,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
