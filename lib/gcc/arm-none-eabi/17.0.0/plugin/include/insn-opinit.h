...
extern insn_code maybe_code_for_mve_vec_extract (machine_mode, machine_mode);
inline insn_code
code_for_mve_vec_extract (machine_mode arg0, machine_mode arg1)
{
  insn_code code = maybe_code_for_mve_vec_extract (arg0, arg1);
  gcc_assert (code != CODE_FOR_nothing);
  return code;
}

extern rtx maybe_gen_mve_vec_extract (machine_mode, machine_mode, rtx, rtx, rtx);
inline rtx
gen_mve_vec_extract (machine_mode arg0, machine_mode arg1, rtx x0, rtx x1, rtx x2)
{
  rtx res = maybe_gen_mve_vec_extract (arg0, arg1, x0, x1, x2);
  gcc_assert (res);
  return res;
}

extern insn_code maybe_code_for_mve_vec_set_internal (machine_mode);
inline insn_code
code_for_mve_vec_set_internal (machine_mode arg0)
{
  insn_code code = maybe_code_for_mve_vec_set_internal (arg0);
  gcc_assert (code != CODE_FOR_nothing);
  return code;
}

extern rtx maybe_gen_mve_vec_set_internal (machine_mode, rtx, rtx, rtx, rtx);
inline rtx
gen_mve_vec_set_internal (machine_mode arg0, rtx x0, rtx x1, rtx x2, rtx x3)
{
  rtx res = maybe_gen_mve_vec_set_internal (arg0, x0, x1, x2, x3);
  gcc_assert (res);
  return res;
}
